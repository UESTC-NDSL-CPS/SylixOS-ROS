...
#--------------文件信息--------------------------------------------------------------------------------
#
# 文   件   名: libaction_msgs__rosidl_typesupport_introspection_cpp.mk
#
# 创   建   人: RealEvo-IDE
#
...
# Target
#*********************************************************************************************************
LOCAL_TARGET_NAME := libaction_msgs__rosidl_typesupport_introspection_cpp.so

#*********************************************************************************************************
# Source list
#*********************************************************************************************************
LOCAL_SRCS :=  \
src/action_msgs/rosidl_typesupport_introspection_cpp/action_msgs/msg/detail/goal_info__type_support.cpp \
src/action_msgs/rosidl_typesupport_introspection_cpp/action_msgs/msg/detail/goal_status_array__type_support.cpp \
src/action_msgs/rosidl_typesupport_introspection_cpp/action_msgs/msg/detail/goal_status__type_support.cpp \
src/action_msgs/rosidl_typesupport_introspection_cpp/action_msgs/srv/detail/cancel_goal__type_support.cpp

#*********************************************************************************************************
# Header file search path (eg. LOCAL_INC_PATH := -I"Your header files search path")
#*********************************************************************************************************
LOCAL_INC_PATH :=  \
-I"./src/action_msgs/rosidl_typesupport_introspection_cpp" \
