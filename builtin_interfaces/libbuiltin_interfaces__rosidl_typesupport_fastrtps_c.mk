...
#--------------文件信息--------------------------------------------------------------------------------
#
# 文   件   名: libbuiltin_interfaces__rosidl_typesupport_fastrtps_c.mk
#
# 创   建   人: RealEvo-IDE
#
...
# Target
#*********************************************************************************************************
LOCAL_TARGET_NAME := libbuiltin_interfaces__rosidl_typesupport_fastrtps_c.so

#*********************************************************************************************************
# Source list
#*********************************************************************************************************
LOCAL_SRCS :=  \
src/builtin_interfaces/rosidl_typesupport_fastrtps_c/builtin_interfaces/msg/detail/duration__type_support_c.cpp \
src/builtin_interfaces/rosidl_typesupport_fastrtps_c/builtin_interfaces/msg/detail/time__type_support_c.cpp

#*********************************************************************************************************
# Header file search path (eg. LOCAL_INC_PATH := -I"Your header files search path")
#*********************************************************************************************************
LOCAL_INC_PATH :=  \
-I"./src/builtin_interfaces/rosidl_typesupport_fastrtps_c" \
...
-I"./src/builtin_interfaces/rosidl_generator_c"
...
$(WORKSPACE_rosidl)/Release/librosidl_typesupport_fastrtps_c.so \
