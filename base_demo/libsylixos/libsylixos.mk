...
SylixOS/arch/arm64/bsp/bspSmp.c \
...
SylixOS/arch/riscv/bsp/bspSmp.c \
...
# LoongArch64 source
#*********************************************************************************************************
LOCAL_LOONGARCH64_SRCS := $(LOCAL_LOONGARCH32_SRCS) 
...
SylixOS/fs/iso9660Fs/iso9660_ds.c \
SylixOS/fs/iso9660Fs/iso9660_fs.c \
SylixOS/fs/iso9660Fs/iso9660_port.c \
SylixOS/fs/iso9660Fs/iso9660_rock.c \
SylixOS/fs/iso9660Fs/iso9660_sector.c \
SylixOS/fs/iso9660Fs/iso9660_sylixos.c \
SylixOS/fs/iso9660Fs/iso9660_utf8.c \
SylixOS/fs/iso9660Fs/iso9660_util.c \
SylixOS/fs/iso9660Fs/iso9660_xa.c \
SylixOS/fs/iso9660Fs/iso9660.c \
...
#*********************************************************************************************************
# Buildin kmodule source
#*********************************************************************************************************
KMODULE_SRC = \
SylixOS/kmodule/xhcesa/init.c \
SylixOS/kmodule/xhcesa/xhcesa.c \
...
SylixOS/kmodule/xtimer/xtimer.c \
...
SylixOS/loader/src/loader_conf.c
...
#*********************************************************************************************************
# merge libloongarch32.a static library into libsylixos.a
#*********************************************************************************************************
ifeq ($(ARCH), loongarch32)
LOCAL_POST_LINK_CMD := mkdir -p $(OUTDIR)/obj/libsylixos.a/SylixOS/arch/loongarch; $(AR) -x SylixOS/arch/loongarch/libloongarch32.a --output=$(OUTDIR)/obj/libsylixos.a/SylixOS/arch/loongarch; $(AR) $(TOOLCHAIN_AR_FLAGS) $(OUTDIR)/libsylixos.a $(OUTDIR)/obj/libsylixos.a/SylixOS/arch/loongarch/*.o
endif

#*********************************************************************************************************
# merge libloongarch64.a static library into libsylixos.a
#*********************************************************************************************************
ifeq ($(ARCH), loongarch64)
LOCAL_POST_LINK_CMD := mkdir -p $(OUTDIR)/obj/libsylixos.a/SylixOS/arch/loongarch; $(AR) -x SylixOS/arch/loongarch/libloongarch64.a --output=$(OUTDIR)/obj/libsylixos.a/SylixOS/arch/loongarch; $(AR) $(TOOLCHAIN_AR_FLAGS) $(OUTDIR)/libsylixos.a $(OUTDIR)/obj/libsylixos.a/SylixOS/arch/loongarch/*.o
endif
