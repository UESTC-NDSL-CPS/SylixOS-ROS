...
extern int  API_PlatformBusInit();
extern int  API_PlatformDeviceRegister();
extern int  API_PlatformDeviceUnregister();
extern int  API_PlatformDriverRegister();
extern int  API_PlatformDriverUnregister();
...
extern int  archSigCtxSave();
extern int  archTaskCtxCopy();
extern int  archTaskCtxStart();
extern int  archTaskCtxSwitch();
extern int  arm64CpuMidrMatch();
extern int  archInvalidExcHandle();
extern int  archSyncExcHandle();
extern int  archEL1ErrInvalidEntry();
extern int  archEL1FiqInvalidEntry();
extern int  archEL1IrqEntry();
extern int  archEL1IrqInvalidEntry();
extern int  archEL1SyncExcEntry();
extern int  archEL1SyncInvalidEntry();
extern int  vector();
...
extern int  arm64GetCurrentEL();
extern int  arm64GetDAIF();
extern int  arm64GetMDSCREL1();
extern int  arm64GetMIDREL1();
extern int  arm64GetNZCV();
extern int  arm64GetSPSel();
extern int  arm64SetMDSCREL1();
extern int  arm64WaitForInterrupt();
extern int  longjmp();
extern int  setjmp();
...
extern int  archDbgIsStep();
extern int  archDbgSchedHook();
extern int  archDbgSetStepMode();
...
extern int  arm64VfpNonePrimaryInit();
extern int  arm64VfpNoneSecondaryInit();
extern int  arm64VfpV4PrimaryInit();
extern int  arm64VfpV4SecondaryInit();
extern int  arm64VfpV4Disable();
extern int  arm64VfpV4Enable();
extern int  arm64VfpV4GetFPSR();
extern int  arm64VfpV4IsEnable();
extern int  arm64VfpV4Mvfr0EL1();
extern int  arm64VfpV4Restore();
extern int  arm64VfpV4Save();
extern int  arm64VfpV4SetFPSR();
extern int  arm64VfpV4El2PrimaryInit();
extern int  arm64VfpV4El2SecondaryInit();
extern int  arm64VfpV4El2Disable();
extern int  arm64VfpV4El2Enable();
extern int  arm64VfpV4El2FpuHandle();
extern int  arm64VfpV4El2IsEnable();
extern int  arm64VfpV4El2Mvfr0EL1();
extern int  arm64VfpV4El2Restore();
extern int  arm64VfpV4El2Save();
...
extern int  arm64CacheInit();
extern int  arm64CacheReset();
extern int  arm64CacheCCSIDR();
extern int  arm64CacheSetCSSELR();
extern int  arm64DCacheClear();
extern int  arm64DCacheClearAll();
extern int  arm64DCacheDisable();
extern int  arm64DCacheEnable();
extern int  arm64DCacheFlush();
extern int  arm64DCacheFlushAll();
extern int  arm64DCacheFlushPoU();
extern int  arm64DCacheInvalidate();
extern int  arm64DCacheInvalidateAll();
extern int  arm64ICacheDisable();
extern int  arm64ICacheEnable();
extern int  arm64ICacheInvalidate();
extern int  arm64ICacheInvalidateAll();
extern int  arm64MmuInit();
extern int  arm64MmuShareableGet();
extern int  arm64MmuShareableSet();
extern int  arm64MmuAbtFaultAddr();
extern int  arm64MmuDisable();
extern int  arm64MmuEnable();
extern int  arm64MmuGetMAIR();
extern int  arm64MmuGetMMFR0();
extern int  arm64MmuGetMMFR1();
extern int  arm64MmuGetSCTLR();
extern int  arm64MmuGetTTBR0();
extern int  arm64MmuInvalidateTLB();
extern int  arm64MmuInvalidateTLBMVA();
extern int  arm64MmuSetMAIR();
extern int  arm64MmuSetTCR();
extern int  arm64MmuSetTTBR();
...
extern int  API_DtraceIsThreadStopped();
...
extern int  __diskCacheNodeFromBuffer();
extern int  __diskCacheNodeGet();
extern int  __diskCacheNodeRead();
extern int  __diskCacheNodeRemove();
extern int  __diskCacheNodeToBuffer();
extern int  __diskCacheRead();
extern int  __diskCacheReadDirect();
extern int  __diskCacheReadMeta();
extern int  __diskCacheReset();
extern int  __diskCacheSortListAdd();
extern int  __diskCacheStatusChk();
extern int  __diskCacheWrite();
extern int  __diskCacheWriteDirect();
extern int  __diskCacheWriteMeta();
...
extern int  API_GptAddEntry();
extern int  API_GptAddEntryWithName();
extern int  API_GptCreateAndInit();
extern int  API_GptCreateAndInitWithLba();
extern int  API_GptDestroy();
extern int  API_GptGetEntry();
extern int  API_GptPartitionBlkLoad();
extern int  API_GptPartitionLoad();
extern int  API_GptPartitionSave();
...
extern int  API_OemDiskFsUmount();
extern int  API_OemDiskGetNPart();
...
extern int  API_OemFdiskEx();
extern int  API_OemFdiskExWithLba();
extern int  API_OemFdiskGet();
extern int  API_OemFdiskGetEx();
...
extern int  tpsFsRollBackSuperBlock();
extern int  tpsFsSetTransMode();
extern int  tpsFsUnmount();
extern int  API_TpsFsDevCreate();
extern int  API_TpsFsDevDelete();
extern int  API_TpsFsDevSync();
extern int  API_TpsFsDrvInstall();
extern int  API_TpsTransModeParam();
...
extern int  tpsFsTransAllocAndInitEx();
extern int  tpsFsTransCommitAndFree();
extern int  tpsFsTransCommitAndFreeEx();
extern int  tpsFsTransFlush();
extern int  tpsFsTransRangeChk();
...
extern int  yaffs_chown();
extern int  yaffs_chown_reldir();
...
extern int  _ThreadClearHetrcc();
extern int  _ThreadGetHetrcc();
extern int  _ThreadSetHetrcc();
extern int  _ThreadTickHetrcc();
...
extern int  API_CpuMaxHetrcc();
extern int  API_CpuUpCurHetrcc();
extern int  API_CpuUpMaxHetrcc();
...
extern int  API_InterDeferJobAddEx();
...
extern int  API_ThreadFastNotePad();
...
extern int  API_ThreadGetHetrcc();
extern int  API_ThreadSetHetrcc();
extern int  API_ThreadIdInter();
extern int  API_ThreadIdSelf();
extern int  API_ThreadIdSelfFast();
extern int  API_ThreadTcbInter();
extern int  API_ThreadTcbSelf();
extern int  API_ThreadTcbSelfFast();
...
extern int  __resAddFileHook();
extern int  __resAddRawHook();
extern int  __resDelFileHook();
...
extern int  __resPidReclaimOnlyFile();
...
extern int  __vmmPhysicalPageFaultWarn();
...
extern int  API_VutexPend();
extern int  API_VutexPendEx();
extern int  API_VutexPost();
extern int  API_VutexPostEx();
extern int  _VutexInitCtx();
extern int  _VutexUnQueue();
extern int  _VutexWaitQueue();
extern int  _VutexWakeIsAll();
extern int  _VutexWakeIsMatch();
extern int  _VutexWakeQueue();
extern int  __assert();
extern int  abort();
extern int  abs();
...
extern int  lib_nlreent_make_local();
...
extern int  vprocIoFileSizeGet();
extern int  vprocIoFileSizeSet();
...
extern int  __moduleVpPatchEnvs();
...
extern int  vprocRun();
extern int  vprocSecRegionGet();
extern int  vprocSecRegionGetCur();
extern int  vprocSecRegionSet();
extern int  vprocSecRegionSetCur();
...
extern int  vprocTlsAlloc();
extern int  vprocTlsFree();
extern int  daemon();
extern int  detach();
extern int  fork();
extern int  getpgid();
...
extern int  waitid();
extern int  waitpid();
extern int  vprocLoadConfFind();
extern int  vprocLoadConfRefresh();
...
extern int  sys_tcp_isn_key_update();
extern int  sys_thread_hostent();
extern int  sys_thread_new();
extern int  sys_thread_sem_get();
extern int  sys_thread_sock_ref();
extern int  sys_thread_sock_unref();
extern int  sys_time_diff();
...
extern int  net_ip_hook_netif_get_secreg();
...
extern int  sendmsg();
extern int  sendto();
extern int  set_dns_server_info_4();
extern int  set_dns_server_info_6();
...
extern int  fcblk_inpkt();
extern int  fcblk_input();
extern int  fcblk_output();
extern int  fcblk_output_ip6();
extern int  fcblk_start();
extern int  fcblk_stop();
extern int  fcipv4_netif_attach();
extern int  fcipv4_netif_detach();
extern int  fcipv4_netif_input();
extern int  fcipv4_netif_output();
extern int  fcipv4_rule_change();
extern int  fcipv4_rule_create();
extern int  fcipv4_rule_delete();
extern int  fcipv4_rule_delif();
extern int  fcipv4_rule_get();
extern int  fcipv4_rule_search();
extern int  fcipv4_rule_traversal();
extern int  fcipv4_total_entry();
extern int  fcipv6_netif_attach();
extern int  fcipv6_netif_detach();
extern int  fcipv6_netif_input();
extern int  fcipv6_netif_output();
extern int  fcipv6_rule_change();
extern int  fcipv6_rule_create();
extern int  fcipv6_rule_delete();
extern int  fcipv6_rule_delif();
extern int  fcipv6_rule_get();
extern int  fcipv6_rule_search();
extern int  fcipv6_rule_traversal();
extern int  fcipv6_total_entry();
extern int  fcnet_netif_add();
extern int  fcnet_netif_attach();
extern int  fcnet_netif_delete();
extern int  fcnet_netif_detach();
extern int  fcnet_netif_get();
extern int  fcnet_netif_output();
extern int  fcnet_netif_output_ip6();
extern int  fcnet_netif_searh();
extern int  fcnet_netif_set();
extern int  fcnet_netif_tcpip_input();
extern int  fcnet_rule_traversal();
extern int  fcnet_total_entry();
...
extern int  netifapi_arp_request();
...
extern int  netifapi_netif_set_dns();
extern int  netifapi_netif_update_flags2();
...
extern int  lwip_socket_thread_down();
...
extern int  tcpip_qos_dscp();
extern int  tcpip_qos_get();
extern int  tcpip_qos_ptr();
...
extern int  netif_dns_setserver();
...
extern int  netif_ip6_addr_clear();
...
extern int  netif_set_neighbor_flush();
...
extern int  mppe_comp_reset();
extern int  mppe_compress();
extern int  mppe_decomp_reset();
extern int  mppe_decompress();
extern int  mppe_init();
extern int  mppe_set_key();
extern int  ccp_reset_comp();
extern int  ccp_reset_decomp();
extern int  ccp_set();
extern int  cdns();
extern int  cif6addr();
extern int  cifaddr();
...
extern int  ppp_netif_get_mtu();
extern int  ppp_netif_set_mtu();
extern int  ppp_new();
extern int  ppp_recv_config();
extern int  ppp_send_config();
extern int  ppp_set_auth();
extern int  ppp_set_mppe();
...
extern int  ieee802154_aes_decrypt();
extern int  ieee802154_aes_encrypt();
extern int  ieee802154_aes_ccm_decrypt();
extern int  ieee802154_aes_ccm_encrypt();
extern int  ieee802154_aes_ccm_verify();
...
extern int  tcp_isn_hook();
extern int  tcp_isn_skey();
...
extern int  API_INetNatTrafficStatGet();
extern int  API_INetNatTrafficStatSet();
...
extern int  __natTrafficIsOn();
extern int  __natTrafficOff();
extern int  __natTrafficOn();
...
extern int  __kmsctp_have_event();
extern int  __kmsctp_set_sockfile();
extern int  API_SctpDrvInstall();
extern int  kmsctp_accept();
extern int  kmsctp_bind();
extern int  kmsctp_close();
extern int  kmsctp_connect();
extern int  kmsctp_getpeername();
extern int  kmsctp_getsockname();
extern int  kmsctp_getsockopt();
extern int  kmsctp_ioctl();
extern int  kmsctp_listen();
extern int  kmsctp_recv();
extern int  kmsctp_recvfrom();
extern int  kmsctp_recvmsg();
extern int  kmsctp_send();
extern int  kmsctp_sendmsg();
extern int  kmsctp_sendto();
extern int  kmsctp_setsockopt();
extern int  kmsctp_shutdown();
extern int  kmsctp_socket();
...
extern int  pthread_gethetrcc_np();
...
extern int  pthread_sethetrcc_np();
...
extern int  posix_spawnattr_getsecreg();
...
extern int  posix_spawnattr_setsecreg();
...
extern int  API_BusFindDevice();
extern int  API_BusInit();
extern int  API_DeviceRegister();
extern int  API_DeviceUnregister();
extern int  API_DevSetDrvdata();
extern int  API_DriverRegister();
extern int  API_DriverUnregister();
...
extern int  API_ClockCoreInit();
extern int  API_ClockDisable();
extern int  API_ClockEnable();
extern int  API_ClockFind();
extern int  API_ClockGetFromProvider();
extern int  API_ClockInitDataSet();
extern int  API_ClockParentSet();
extern int  API_ClockProviderAdd();
extern int  API_ClockRateGet();
extern int  API_ClockRateRound();
extern int  API_ClockRateSet();
extern int  API_ClockRegister();
extern int  API_ClockSimpleGet();
extern int  API_ClockDividerRegister();
extern int  API_ClockFixedFactorRegister();
extern int  API_ClockFixedRateRegister();
extern int  API_ClockGateRegister();
extern int  API_ClockMuxRegister();
...
extern int  API_GpioCtrlRegister();
extern int  API_GpioCtrlUnregister();
extern int  API_GMemDevAdd();
extern int  API_GMemDevStatus();
...
extern int  API_I2cAdapterRegister();
extern int  API_I2cAdapterUnregister();
extern int  API_I2cBusGet();
extern int  API_I2cBusInit();
extern int  API_I2cBusTransfer();
extern int  API_I2cDevDelete();
extern int  API_I2cDevRegister();
extern int  API_I2cDevTransfer();
extern int  API_I2cDrvRegister();
extern int  API_I2cDrvUnregister();
extern int  API_IrqCtrlDevCreate();
extern int  API_IrqCtrlDevDelete();
extern int  API_IrqCtrlDevFind();
extern int  API_IrqCtrlDevtreeNodeMatch();
extern int  API_IrqCtrlDevtreeTrans();
extern int  API_IrqCtrlFindVectorByHwIrq();
extern int  API_IrqCtrlHwIrqMapToVector();
extern int  API_MemDevCreate();
extern int  API_MemDevCreateDir();
extern int  API_MemDevDelete();
extern int  API_MemDrvInstall();
extern int  API_MdioAdapterRegister();
extern int  API_MdioBusGet();
extern int  API_MdioBusInit();
extern int  API_MdioBusRead();
extern int  API_MdioBusReset();
extern int  API_MdioBusWrite();
extern int  API_MdioDevCreate();
extern int  API_MdioDevDelete();
extern int  API_MdioDevRead();
extern int  API_MdioDevRegister();
extern int  API_MdioDevWrite();
extern int  API_MdioDrvRegister();
extern int  API_PhyDevCreate();
extern int  API_PhyRead();
extern int  API_PhyWrite();
...
extern int  API_PinConfigApply();
extern int  API_PinConfigMapToSetting();
extern int  API_PinConfigMapValidate();
extern int  API_PinBind();
extern int  API_PinCtrlGet();
extern int  API_PinCtrlGroupSelectorGet();
extern int  API_PinCtrlMapAdd();
extern int  API_PinCtrlMapDel();
extern int  API_PinCtrlPinGetByName();
extern int  API_PinCtrlStateFind();
extern int  API_PinCtrlStateSelect();
extern int  API_PinCtrlDescBuild();
extern int  API_PinCtrlDevCreate();
extern int  API_PinCtrlDevGetByDevtreeNode();
extern int  API_PinCtrlGpioFree();
extern int  API_PinCtrlGpioRangeAdd();
extern int  API_PinCtrlGpioRangeRemove();
extern int  API_PinCtrlGpioRequest();
extern int  API_PinCtrlPinDescDel();
extern int  API_PinCtrlPinDescGet();
extern int  API_PinMuxDisable();
extern int  API_PinMuxEnable();
extern int  API_PinMuxMapToSetting();
extern int  API_PinMuxMapValidate();
...
extern int  API_SpiBusGet();
extern int  API_SpiBusInit();
extern int  API_SpiCtrlRegister();
extern int  API_SpiCtrlUnregister();
extern int  API_SpiDevDelete();
extern int  API_SpiDevRegister();
extern int  API_SpiDevSetup();
extern int  API_SpiDevTransfer();
extern int  API_SpiDrvRegister();
extern int  API_SpiDrvUnregister();
extern int  API_SpiRead();
extern int  API_SpiW8R16();
extern int  API_SpiW8R8();
extern int  API_SpiWrite();
extern int  API_SpiWriteThenRead();
...
extern int  API_RegulatorCurrentLimitGet();
extern int  API_RegulatorCurrentLimitSet();
extern int  API_RegulatorDisable();
extern int  API_RegulatorEnable();
extern int  API_RegulatorGet();
extern int  API_RegulatorInit();
extern int  API_RegulatorIsEnabled();
extern int  API_RegulatorRegister();
extern int  API_RegulatorVoltageGet();
extern int  API_RegulatorVoltageSet();
extern int  API_SystemHwInfoPrint();
extern int  API_SystemLogoPrint();
extern int  API_DWatchDevCreate();
extern int  API_DWatchDrvInstall();
extern int  dwatch();
extern int  dwatchDevDeleteHook();
extern int  dwatchDevNotifyHook();
...
extern int  API_IosDrvGetFeatures();
...
extern int  _doSigEventVmmAbort();
...
extern int  API_DeviceTreeDefaultPopulate();
extern int  API_DeviceTreeDevEarlyInit();
extern int  API_DeviceTreeDevGetMatchData();
extern int  API_DeviceTreeDevGetMatchTable();
extern int  API_DeviceTreeDevPopulate();
extern int  API_DeviceTreeDrvMatchDev();
extern int  API_DeviceTreeIsCompatible();
extern int  API_DeviceTreeIrqCountGet();
extern int  API_DeviceTreeIrqFindParent();
extern int  API_DeviceTreeIrqGet();
extern int  API_DeviceTreeIrqOneParse();
extern int  API_DeviceTreeIrqRawParse();
extern int  API_DeviceTreeIrqToResouceTable();
extern int  API_DeviceTreeIrqToResource();
extern int  API_DeviceTreeClockGet();
extern int  API_DeviceTreeClockGetByName();
extern int  API_DeviceTreeParentClockNameGet();
extern int  API_DeviceTreeGpioCtrlRegister();
extern int  API_DeviceTreeGpioCtrlRemove();
extern int  API_DeviceTreeGpioNamedCountGet();
extern int  API_DeviceTreeGpioNamedGpioGet();
extern int  API_DeviceTreeGpioPinRangeAdd();
extern int  API_DeviceTreeGpioPinRangeRemove();
extern int  API_DeviceTreePinCtrlDevGet();
extern int  API_DeviceTreePinCtrlMapsCreate();
extern int  API_DeviceTreePinCtrlMapsFree();
extern int  API_DeviceTreeAliasIdGet();
extern int  API_DeviceTreeHighLevelInit();
extern int  API_DeviceTreeKernelStartParamGet();
extern int  API_DeviceTreeKernelVmmParamGet();
extern int  API_DeviceTreeLowLevelInit();
extern int  API_DeviceTreeAddressGet();
extern int  API_DeviceTreeAddressIoremap();
extern int  API_DeviceTreeAddressTranslate();
extern int  API_DeviceTreeFindAllNodes();
extern int  API_DeviceTreeFindNodeOptsByPath();
extern int  API_DeviceTreeNAddrCells();
extern int  API_DeviceTreeNextChildGet();
extern int  API_DeviceTreeNSizeCells();
extern int  API_DeviceTreeRegAddressGet();
extern int  API_DeviceTreeResourceGet();
extern int  API_DeviceTreeMdioDevFind();
extern int  API_DeviceTreeMdioDevRegister();
extern int  API_DeviceTreeMdioRegister();
extern int  API_DeviceTreeI2cAdapterRegister();
extern int  API_DeviceTreeI2cDevRegister();
extern int  API_DeviceTreeSpiCtrlRegister();
extern int  API_DeviceTreeSpiDevRegister();
extern int  API_DeviceTreePciBusRangeParse();
extern int  API_DeviceTreePciHostBridgeResourcesGet();
extern int  API_DeviceTreePciRangesParse();
extern int  API_DeviceTreeFindNodeByPhandle();
extern int  API_DeviceTreePhandleCountWithArgs();
extern int  API_DeviceTreePhandleIteratorInit();
extern int  API_DeviceTreePhandleIteratorNext();
extern int  API_DeviceTreePhandleParse();
extern int  API_DeviceTreePhandleParseFixedArgs();
extern int  API_DeviceTreePhandleParseWithArgs();
extern int  API_DeviceTreeModaliasGet();
extern int  API_DeviceTreeNodeIsOkay();
extern int  API_DeviceTreeNodeIsOkayByOffset();
extern int  API_DeviceTreePropertyBoolRead();
extern int  API_DeviceTreePropertyFind();
extern int  API_DeviceTreePropertyGet();
extern int  API_DeviceTreePropertyStringCount();
extern int  API_DeviceTreePropertyStringHelperRead();
extern int  API_DeviceTreePropertyStringIndexRead();
extern int  API_DeviceTreePropertyStringMatch();
extern int  API_DeviceTreePropertyStringNext();
extern int  API_DeviceTreePropertyStringRead();
extern int  API_DeviceTreePropertyU32ArrayRead();
extern int  API_DeviceTreePropertyU32IndexRead();
extern int  API_DeviceTreePropertyU32Next();
extern int  API_DeviceTreePropertyU32Read();
extern int  API_DeviceTreePropertyU32VaraiableArrayRead();
extern int  fdtdec_get_int();
extern int  fdtdec_get_uint();
extern int  fdt_get_named_resource();
extern int  fdt_get_resource();
extern int  fdtdec_add_aliases_for_id();
extern int  fdtdec_check_fdt();
extern int  fdtdec_decode_display_timing();
extern int  fdtdec_find_aliases_for_id();
extern int  fdtdec_get_addr();
extern int  fdtdec_get_addr_size();
extern int  fdtdec_get_addr_size_auto_noparent();
extern int  fdtdec_get_addr_size_auto_parent();
extern int  fdtdec_get_addr_size_fixed();
extern int  fdtdec_get_alias_highest_id();
extern int  fdtdec_get_alias_seq();
extern int  fdtdec_get_bool();
extern int  fdtdec_get_byte_array();
extern int  fdtdec_get_child_count();
extern int  fdtdec_get_chosen_node();
extern int  fdtdec_get_chosen_prop();
extern int  fdtdec_get_compatible();
extern int  fdtdec_get_config_bool();
extern int  fdtdec_get_config_int();
extern int  fdtdec_get_config_string();
extern int  fdtdec_get_int_array();
extern int  fdtdec_get_int_array_count();
extern int  fdtdec_get_is_enabled();
extern int  fdtdec_get_number();
extern int  fdtdec_get_uint64();
extern int  fdtdec_locate_array();
extern int  fdtdec_locate_byte_array();
extern int  fdtdec_lookup();
extern int  fdtdec_lookup_phandle();
extern int  fdtdec_next_alias();
extern int  fdtdec_next_compatible();
extern int  fdtdec_next_compatible_subnode();
extern int  fdtdec_parse_phandle_with_args();
extern int  fdtdec_prepare_fdt();
extern int  fdtdec_setup();
extern int  fdt_address_cells();
extern int  fdt_appendprop_addrrange();
extern int  fdt_size_cells();
extern int  fdt_create_empty_tree();
extern int  fdt_overlay_apply();
extern int  fdt_check_full();
extern int  fdt_find_max_phandle();
extern int  fdt_first_property_offset();
extern int  fdt_generate_phandle();
extern int  fdt_get_alias();
extern int  fdt_get_alias_namelen();
extern int  fdt_get_mem_rsv();
extern int  fdt_get_name();
extern int  fdt_get_path();
extern int  fdt_get_phandle();
extern int  fdt_get_property();
extern int  fdt_get_property_by_offset();
extern int  fdt_get_property_namelen();
extern int  fdt_get_string();
extern int  fdt_getprop();
extern int  fdt_getprop_by_offset();
extern int  fdt_getprop_namelen();
extern int  fdt_next_property_offset();
extern int  fdt_node_check_compatible();
extern int  fdt_node_depth();
extern int  fdt_node_offset_by_compatible();
extern int  fdt_node_offset_by_phandle();
extern int  fdt_node_offset_by_prop_value();
extern int  fdt_num_mem_rsv();
extern int  fdt_parent_offset();
extern int  fdt_path_offset();
extern int  fdt_path_offset_namelen();
extern int  fdt_string();
extern int  fdt_stringlist_contains();
extern int  fdt_stringlist_count();
extern int  fdt_stringlist_get();
extern int  fdt_stringlist_search();
extern int  fdt_subnode_offset();
extern int  fdt_subnode_offset_namelen();
extern int  fdt_supernode_atdepth_offset();
extern int  fdt_add_mem_rsv();
extern int  fdt_add_subnode();
extern int  fdt_add_subnode_namelen();
extern int  fdt_appendprop();
extern int  fdt_del_mem_rsv();
extern int  fdt_del_node();
extern int  fdt_delprop();
extern int  fdt_open_into();
extern int  fdt_pack();
extern int  fdt_set_name();
extern int  fdt_setprop();
extern int  fdt_setprop_placeholder();
extern int  fdt_strerror();
extern int  fdt_add_reservemap_entry();
extern int  fdt_begin_node();
extern int  fdt_create();
extern int  fdt_end_node();
extern int  fdt_finish();
extern int  fdt_finish_reservemap();
extern int  fdt_property();
extern int  fdt_property_placeholder();
extern int  fdt_resize();
extern int  fdt_node_end_offset_();
extern int  fdt_nop_node();
extern int  fdt_nop_property();
extern int  fdt_setprop_inplace();
extern int  fdt_setprop_inplace_namelen_partial();
extern int  fdt_check_header();
extern int  fdt_check_node_offset_();
extern int  fdt_check_prop_offset_();
extern int  fdt_find_string_();
extern int  fdt_first_subnode();
extern int  fdt_header_size_();
extern int  fdt_move();
extern int  fdt_next_node();
extern int  fdt_next_subnode();
extern int  fdt_next_tag();
extern int  fdt_offset_ptr();
extern int  fdt_ro_probe_();
extern int  bspCpuLogic2Hetrcc();
...
extern int  arm64EL2SwitchEL1();
extern int  arm64SwitchToEl1();
extern int  arm64VfpV4HwInit();
extern int  arm64VfpV4El2HwInit();
extern int  archMpCur();
extern int  archMpInt();
extern int  arm64MpidrGet();
extern int  bspSio16c550SetHighBaud();
...
extern int  _G_sysperfparam;
extern int  _G_pdtnAliases;
extern int  _G_pdtnRoot;
extern int  _G_ppdtnPhandleCache;
extern int  _G_uiPhandleCacheMask;
...
SYMBOL_ITEM_FUNC(API_PlatformBusInit)
SYMBOL_ITEM_FUNC(API_PlatformDeviceRegister)
SYMBOL_ITEM_FUNC(API_PlatformDeviceUnregister)
SYMBOL_ITEM_FUNC(API_PlatformDriverRegister)
SYMBOL_ITEM_FUNC(API_PlatformDriverUnregister)
...
SYMBOL_ITEM_FUNC(archSigCtxSave)
SYMBOL_ITEM_FUNC(archTaskCtxCopy)
SYMBOL_ITEM_FUNC(archTaskCtxStart)
SYMBOL_ITEM_FUNC(archTaskCtxSwitch)
SYMBOL_ITEM_FUNC(arm64CpuMidrMatch)
SYMBOL_ITEM_FUNC(archInvalidExcHandle)
SYMBOL_ITEM_FUNC(archSyncExcHandle)
SYMBOL_ITEM_FUNC(archEL1ErrInvalidEntry)
SYMBOL_ITEM_FUNC(archEL1FiqInvalidEntry)
SYMBOL_ITEM_FUNC(archEL1IrqEntry)
SYMBOL_ITEM_FUNC(archEL1IrqInvalidEntry)
SYMBOL_ITEM_FUNC(archEL1SyncExcEntry)
SYMBOL_ITEM_FUNC(archEL1SyncInvalidEntry)
SYMBOL_ITEM_FUNC(vector)
...
SYMBOL_ITEM_FUNC(arm64GetCurrentEL)
SYMBOL_ITEM_FUNC(arm64GetDAIF)
SYMBOL_ITEM_FUNC(arm64GetMDSCREL1)
SYMBOL_ITEM_FUNC(arm64GetMIDREL1)
SYMBOL_ITEM_FUNC(arm64GetNZCV)
SYMBOL_ITEM_FUNC(arm64GetSPSel)
SYMBOL_ITEM_FUNC(arm64SetMDSCREL1)
SYMBOL_ITEM_FUNC(arm64WaitForInterrupt)
...
SYMBOL_ITEM_FUNC(archDbgIsStep)
SYMBOL_ITEM_FUNC(archDbgSchedHook)
SYMBOL_ITEM_FUNC(archDbgSetStepMode)
...
SYMBOL_ITEM_FUNC(arm64VfpNonePrimaryInit)
SYMBOL_ITEM_FUNC(arm64VfpNoneSecondaryInit)
SYMBOL_ITEM_FUNC(arm64VfpV4PrimaryInit)
SYMBOL_ITEM_FUNC(arm64VfpV4SecondaryInit)
SYMBOL_ITEM_FUNC(arm64VfpV4Disable)
SYMBOL_ITEM_FUNC(arm64VfpV4Enable)
SYMBOL_ITEM_FUNC(arm64VfpV4GetFPSR)
SYMBOL_ITEM_FUNC(arm64VfpV4IsEnable)
SYMBOL_ITEM_FUNC(arm64VfpV4Mvfr0EL1)
SYMBOL_ITEM_FUNC(arm64VfpV4Restore)
SYMBOL_ITEM_FUNC(arm64VfpV4Save)
SYMBOL_ITEM_FUNC(arm64VfpV4SetFPSR)
SYMBOL_ITEM_FUNC(arm64VfpV4El2PrimaryInit)
SYMBOL_ITEM_FUNC(arm64VfpV4El2SecondaryInit)
SYMBOL_ITEM_FUNC(arm64VfpV4El2Disable)
SYMBOL_ITEM_FUNC(arm64VfpV4El2Enable)
SYMBOL_ITEM_FUNC(arm64VfpV4El2FpuHandle)
SYMBOL_ITEM_FUNC(arm64VfpV4El2IsEnable)
SYMBOL_ITEM_FUNC(arm64VfpV4El2Mvfr0EL1)
SYMBOL_ITEM_FUNC(arm64VfpV4El2Restore)
SYMBOL_ITEM_FUNC(arm64VfpV4El2Save)
...
SYMBOL_ITEM_FUNC(arm64CacheInit)
SYMBOL_ITEM_FUNC(arm64CacheReset)
SYMBOL_ITEM_FUNC(arm64CacheCCSIDR)
SYMBOL_ITEM_FUNC(arm64CacheSetCSSELR)
SYMBOL_ITEM_FUNC(arm64DCacheClear)
SYMBOL_ITEM_FUNC(arm64DCacheClearAll)
SYMBOL_ITEM_FUNC(arm64DCacheDisable)
SYMBOL_ITEM_FUNC(arm64DCacheEnable)
SYMBOL_ITEM_FUNC(arm64DCacheFlush)
SYMBOL_ITEM_FUNC(arm64DCacheFlushAll)
SYMBOL_ITEM_FUNC(arm64DCacheFlushPoU)
SYMBOL_ITEM_FUNC(arm64DCacheInvalidate)
SYMBOL_ITEM_FUNC(arm64DCacheInvalidateAll)
SYMBOL_ITEM_FUNC(arm64ICacheDisable)
SYMBOL_ITEM_FUNC(arm64ICacheEnable)
SYMBOL_ITEM_FUNC(arm64ICacheInvalidate)
SYMBOL_ITEM_FUNC(arm64ICacheInvalidateAll)
SYMBOL_ITEM_FUNC(arm64MmuInit)
SYMBOL_ITEM_FUNC(arm64MmuShareableGet)
SYMBOL_ITEM_FUNC(arm64MmuShareableSet)
SYMBOL_ITEM_FUNC(arm64MmuAbtFaultAddr)
SYMBOL_ITEM_FUNC(arm64MmuDisable)
SYMBOL_ITEM_FUNC(arm64MmuEnable)
SYMBOL_ITEM_FUNC(arm64MmuGetMAIR)
SYMBOL_ITEM_FUNC(arm64MmuGetMMFR0)
SYMBOL_ITEM_FUNC(arm64MmuGetMMFR1)
SYMBOL_ITEM_FUNC(arm64MmuGetSCTLR)
SYMBOL_ITEM_FUNC(arm64MmuGetTTBR0)
SYMBOL_ITEM_FUNC(arm64MmuInvalidateTLB)
SYMBOL_ITEM_FUNC(arm64MmuInvalidateTLBMVA)
SYMBOL_ITEM_FUNC(arm64MmuSetMAIR)
SYMBOL_ITEM_FUNC(arm64MmuSetTCR)
SYMBOL_ITEM_FUNC(arm64MmuSetTTBR)
...
SYMBOL_ITEM_FUNC(API_DtraceIsThreadStopped)
...
SYMBOL_ITEM_FUNC(API_DiskCacheParam)
...
SYMBOL_ITEM_FUNC(__diskCacheNodeFromBuffer)
SYMBOL_ITEM_FUNC(__diskCacheNodeGet)
SYMBOL_ITEM_FUNC(__diskCacheNodeRead)
SYMBOL_ITEM_FUNC(__diskCacheNodeRemove)
SYMBOL_ITEM_FUNC(__diskCacheNodeToBuffer)
SYMBOL_ITEM_FUNC(__diskCacheRead)
SYMBOL_ITEM_FUNC(__diskCacheReadDirect)
SYMBOL_ITEM_FUNC(__diskCacheReadMeta)
...
SYMBOL_ITEM_FUNC(__diskCacheWriteDirect)
SYMBOL_ITEM_FUNC(__diskCacheWriteMeta)
...
SYMBOL_ITEM_FUNC(API_GptAddEntry)
SYMBOL_ITEM_FUNC(API_GptAddEntryWithName)
SYMBOL_ITEM_FUNC(API_GptCreateAndInit)
SYMBOL_ITEM_FUNC(API_GptCreateAndInitWithLba)
SYMBOL_ITEM_FUNC(API_GptDestroy)
SYMBOL_ITEM_FUNC(API_GptGetEntry)
SYMBOL_ITEM_FUNC(API_GptPartitionBlkLoad)
SYMBOL_ITEM_FUNC(API_GptPartitionLoad)
SYMBOL_ITEM_FUNC(API_GptPartitionSave)
...
SYMBOL_ITEM_FUNC(API_OemDiskFsUmount)
SYMBOL_ITEM_FUNC(API_OemDiskGetNPart)
...
SYMBOL_ITEM_FUNC(API_OemFdiskEx)
SYMBOL_ITEM_FUNC(API_OemFdiskExWithLba)
SYMBOL_ITEM_FUNC(API_OemFdiskGet)
SYMBOL_ITEM_FUNC(API_OemFdiskGetEx)
...
SYMBOL_ITEM_FUNC(tpsFsRollBackSuperBlock)
SYMBOL_ITEM_FUNC(tpsFsSetTransMode)
SYMBOL_ITEM_FUNC(tpsFsUnmount)
SYMBOL_ITEM_FUNC(API_TpsFsDevCreate)
SYMBOL_ITEM_FUNC(API_TpsFsDevDelete)
SYMBOL_ITEM_FUNC(API_TpsFsDevSync)
SYMBOL_ITEM_FUNC(API_TpsFsDrvInstall)
SYMBOL_ITEM_FUNC(API_TpsTransModeParam)
...
SYMBOL_ITEM_FUNC(tpsFsTransAllocAndInitEx)
SYMBOL_ITEM_FUNC(tpsFsTransCommitAndFree)
SYMBOL_ITEM_FUNC(tpsFsTransCommitAndFreeEx)
SYMBOL_ITEM_FUNC(tpsFsTransFlush)
SYMBOL_ITEM_FUNC(tpsFsTransRangeChk)
...
SYMBOL_ITEM_FUNC(yaffs_chown)
SYMBOL_ITEM_FUNC(yaffs_chown_reldir)
...
SYMBOL_ITEM_FUNC(__context_show)
...
SYMBOL_ITEM_FUNC(_ThreadClearHetrcc)
SYMBOL_ITEM_FUNC(_ThreadGetHetrcc)
SYMBOL_ITEM_FUNC(_ThreadSetHetrcc)
SYMBOL_ITEM_FUNC(_ThreadTickHetrcc)
...
SYMBOL_ITEM_FUNC(_ThreadSchedInfo)
...
SYMBOL_ITEM_FUNC(API_CpuMaxHetrcc)
SYMBOL_ITEM_FUNC(API_CpuUpCurHetrcc)
SYMBOL_ITEM_FUNC(API_CpuUpMaxHetrcc)
...
SYMBOL_ITEM_FUNC(API_InterDeferJobAddEx)
...
SYMBOL_ITEM_FUNC(API_ThreadFastNotePad)
...
SYMBOL_ITEM_FUNC(API_ThreadGetHetrcc)
SYMBOL_ITEM_FUNC(API_ThreadSetHetrcc)
SYMBOL_ITEM_FUNC(API_ThreadIdInter)
SYMBOL_ITEM_FUNC(API_ThreadIdSelf)
SYMBOL_ITEM_FUNC(API_ThreadIdSelfFast)
SYMBOL_ITEM_FUNC(API_ThreadTcbInter)
SYMBOL_ITEM_FUNC(API_ThreadTcbSelf)
SYMBOL_ITEM_FUNC(API_ThreadTcbSelfFast)
...
SYMBOL_ITEM_FUNC(__threadCanJoin)
...
SYMBOL_ITEM_FUNC(__resAddFileHook)
SYMBOL_ITEM_FUNC(__resAddRawHook)
SYMBOL_ITEM_FUNC(__resDelFileHook)
...
SYMBOL_ITEM_FUNC(__resPidReclaimOnlyFile)
...
SYMBOL_ITEM_FUNC(API_StackShowEx)
...
SYMBOL_ITEM_FUNC(__vmmPhysicalPageFaultWarn)
...
SYMBOL_ITEM_FUNC(API_VutexPend)
SYMBOL_ITEM_FUNC(API_VutexPendEx)
SYMBOL_ITEM_FUNC(API_VutexPost)
SYMBOL_ITEM_FUNC(API_VutexPostEx)
SYMBOL_ITEM_FUNC(_VutexInitCtx)
SYMBOL_ITEM_FUNC(_VutexUnQueue)
SYMBOL_ITEM_FUNC(_VutexWaitQueue)
SYMBOL_ITEM_FUNC(_VutexWakeIsAll)
SYMBOL_ITEM_FUNC(_VutexWakeIsMatch)
SYMBOL_ITEM_FUNC(_VutexWakeQueue)
...
SYMBOL_ITEM_FUNC(__daysSinceYear)
...
SYMBOL_ITEM_FUNC(lib_nlreent_make_local)
...
SYMBOL_ITEM_FUNC(vprocIoFileCloExec)
...
SYMBOL_ITEM_FUNC(vprocIoFileSizeGet)
SYMBOL_ITEM_FUNC(vprocIoFileSizeSet)
...
SYMBOL_ITEM_FUNC(__ldSetMemText)
...
SYMBOL_ITEM_FUNC(__moduleVpPatchEnvs)
...
SYMBOL_ITEM_FUNC(vprocAddrIsInside)
...
SYMBOL_ITEM_FUNC(vprocSecRegionGet)
SYMBOL_ITEM_FUNC(vprocSecRegionGetCur)
SYMBOL_ITEM_FUNC(vprocSecRegionSet)
SYMBOL_ITEM_FUNC(vprocSecRegionSetCur)
...
SYMBOL_ITEM_FUNC(vprocTlsAlloc)
SYMBOL_ITEM_FUNC(vprocTlsFree)
...
SYMBOL_ITEM_FUNC(vprocLoadConfFind)
SYMBOL_ITEM_FUNC(vprocLoadConfRefresh)
...
SYMBOL_ITEM_FUNC(sys_tcp_isn_key_update)
SYMBOL_ITEM_FUNC(sys_thread_hostent)
SYMBOL_ITEM_FUNC(sys_thread_new)
SYMBOL_ITEM_FUNC(sys_thread_sem_get)
SYMBOL_ITEM_FUNC(sys_thread_sock_ref)
SYMBOL_ITEM_FUNC(sys_thread_sock_unref)
SYMBOL_ITEM_FUNC(sys_time_diff)
...
SYMBOL_ITEM_FUNC(net_ip_hook_netif_get_secreg)
...
SYMBOL_ITEM_FUNC(set_dns_server_info_4)
SYMBOL_ITEM_FUNC(set_dns_server_info_6)
...
SYMBOL_ITEM_FUNC(fcblk_inpkt)
SYMBOL_ITEM_FUNC(fcblk_input)
SYMBOL_ITEM_FUNC(fcblk_output)
SYMBOL_ITEM_FUNC(fcblk_output_ip6)
SYMBOL_ITEM_FUNC(fcblk_start)
SYMBOL_ITEM_FUNC(fcblk_stop)
SYMBOL_ITEM_FUNC(fcipv4_netif_attach)
SYMBOL_ITEM_FUNC(fcipv4_netif_detach)
SYMBOL_ITEM_FUNC(fcipv4_netif_input)
SYMBOL_ITEM_FUNC(fcipv4_netif_output)
SYMBOL_ITEM_FUNC(fcipv4_rule_change)
SYMBOL_ITEM_FUNC(fcipv4_rule_create)
SYMBOL_ITEM_FUNC(fcipv4_rule_delete)
SYMBOL_ITEM_FUNC(fcipv4_rule_delif)
SYMBOL_ITEM_FUNC(fcipv4_rule_get)
SYMBOL_ITEM_FUNC(fcipv4_rule_search)
SYMBOL_ITEM_FUNC(fcipv4_rule_traversal)
SYMBOL_ITEM_FUNC(fcipv4_total_entry)
SYMBOL_ITEM_FUNC(fcipv6_netif_attach)
SYMBOL_ITEM_FUNC(fcipv6_netif_detach)
SYMBOL_ITEM_FUNC(fcipv6_netif_input)
SYMBOL_ITEM_FUNC(fcipv6_netif_output)
SYMBOL_ITEM_FUNC(fcipv6_rule_change)
SYMBOL_ITEM_FUNC(fcipv6_rule_create)
SYMBOL_ITEM_FUNC(fcipv6_rule_delete)
SYMBOL_ITEM_FUNC(fcipv6_rule_delif)
SYMBOL_ITEM_FUNC(fcipv6_rule_get)
SYMBOL_ITEM_FUNC(fcipv6_rule_search)
SYMBOL_ITEM_FUNC(fcipv6_rule_traversal)
SYMBOL_ITEM_FUNC(fcipv6_total_entry)
SYMBOL_ITEM_FUNC(fcnet_netif_add)
SYMBOL_ITEM_FUNC(fcnet_netif_attach)
SYMBOL_ITEM_FUNC(fcnet_netif_delete)
SYMBOL_ITEM_FUNC(fcnet_netif_detach)
SYMBOL_ITEM_FUNC(fcnet_netif_get)
SYMBOL_ITEM_FUNC(fcnet_netif_output)
SYMBOL_ITEM_FUNC(fcnet_netif_output_ip6)
SYMBOL_ITEM_FUNC(fcnet_netif_searh)
SYMBOL_ITEM_FUNC(fcnet_netif_set)
SYMBOL_ITEM_FUNC(fcnet_netif_tcpip_input)
SYMBOL_ITEM_FUNC(fcnet_rule_traversal)
SYMBOL_ITEM_FUNC(fcnet_total_entry)
...
SYMBOL_ITEM_FUNC(netifapi_arp_request)
...
SYMBOL_ITEM_FUNC(netifapi_netif_set_dns)
SYMBOL_ITEM_FUNC(netifapi_netif_update_flags2)
...
SYMBOL_ITEM_FUNC(lwip_socket_thread_down)
...
SYMBOL_ITEM_FUNC(tcpip_qos_dscp)
SYMBOL_ITEM_FUNC(tcpip_qos_get)
SYMBOL_ITEM_FUNC(tcpip_qos_ptr)
...
SYMBOL_ITEM_FUNC(netif_dns_setserver)
...
SYMBOL_ITEM_FUNC(netif_ip6_addr_clear)
...
SYMBOL_ITEM_FUNC(netif_set_neighbor_flush)
...
SYMBOL_ITEM_FUNC(tcp_rst_netif)
...
SYMBOL_ITEM_FUNC(ccp_resetrequest)
...
SYMBOL_ITEM_FUNC(mppe_comp_reset)
SYMBOL_ITEM_FUNC(mppe_compress)
SYMBOL_ITEM_FUNC(mppe_decomp_reset)
SYMBOL_ITEM_FUNC(mppe_decompress)
SYMBOL_ITEM_FUNC(mppe_init)
SYMBOL_ITEM_FUNC(mppe_set_key)
SYMBOL_ITEM_FUNC(ccp_reset_comp)
SYMBOL_ITEM_FUNC(ccp_reset_decomp)
SYMBOL_ITEM_FUNC(ccp_set)
...
SYMBOL_ITEM_FUNC(ieee802154_aes_decrypt)
SYMBOL_ITEM_FUNC(ieee802154_aes_encrypt)
SYMBOL_ITEM_FUNC(ieee802154_aes_ccm_decrypt)
SYMBOL_ITEM_FUNC(ieee802154_aes_ccm_encrypt)
SYMBOL_ITEM_FUNC(ieee802154_aes_ccm_verify)
...
SYMBOL_ITEM_FUNC(tcp_isn_hook)
SYMBOL_ITEM_FUNC(tcp_isn_skey)
...
SYMBOL_ITEM_FUNC(API_INetNatTrafficStatGet)
SYMBOL_ITEM_FUNC(API_INetNatTrafficStatSet)
...
SYMBOL_ITEM_FUNC(__natTrafficIsOn)
SYMBOL_ITEM_FUNC(__natTrafficOff)
SYMBOL_ITEM_FUNC(__natTrafficOn)
...
SYMBOL_ITEM_FUNC(__kmsctp_have_event)
SYMBOL_ITEM_FUNC(__kmsctp_set_sockfile)
SYMBOL_ITEM_FUNC(API_SctpDrvInstall)
SYMBOL_ITEM_FUNC(kmsctp_accept)
SYMBOL_ITEM_FUNC(kmsctp_bind)
SYMBOL_ITEM_FUNC(kmsctp_close)
SYMBOL_ITEM_FUNC(kmsctp_connect)
SYMBOL_ITEM_FUNC(kmsctp_getpeername)
SYMBOL_ITEM_FUNC(kmsctp_getsockname)
SYMBOL_ITEM_FUNC(kmsctp_getsockopt)
SYMBOL_ITEM_FUNC(kmsctp_ioctl)
SYMBOL_ITEM_FUNC(kmsctp_listen)
SYMBOL_ITEM_FUNC(kmsctp_recv)
SYMBOL_ITEM_FUNC(kmsctp_recvfrom)
SYMBOL_ITEM_FUNC(kmsctp_recvmsg)
SYMBOL_ITEM_FUNC(kmsctp_send)
SYMBOL_ITEM_FUNC(kmsctp_sendmsg)
SYMBOL_ITEM_FUNC(kmsctp_sendto)
SYMBOL_ITEM_FUNC(kmsctp_setsockopt)
SYMBOL_ITEM_FUNC(kmsctp_shutdown)
SYMBOL_ITEM_FUNC(kmsctp_socket)
...
SYMBOL_ITEM_FUNC(pthread_gethetrcc_np)
...
SYMBOL_ITEM_FUNC(pthread_sethetrcc_np)
...
SYMBOL_ITEM_FUNC(posix_spawnattr_getsecreg)
...
SYMBOL_ITEM_FUNC(posix_spawnattr_setsecreg)
...
SYMBOL_ITEM_FUNC(API_TShellExecBgEx)
...
SYMBOL_ITEM_FUNC(API_BusFindDevice)
SYMBOL_ITEM_FUNC(API_BusInit)
SYMBOL_ITEM_FUNC(API_DeviceRegister)
SYMBOL_ITEM_FUNC(API_DeviceUnregister)
SYMBOL_ITEM_FUNC(API_DevSetDrvdata)
SYMBOL_ITEM_FUNC(API_DriverRegister)
SYMBOL_ITEM_FUNC(API_DriverUnregister)
...
SYMBOL_ITEM_FUNC(API_ClockCoreInit)
SYMBOL_ITEM_FUNC(API_ClockDisable)
SYMBOL_ITEM_FUNC(API_ClockEnable)
SYMBOL_ITEM_FUNC(API_ClockFind)
SYMBOL_ITEM_FUNC(API_ClockGetFromProvider)
SYMBOL_ITEM_FUNC(API_ClockInitDataSet)
SYMBOL_ITEM_FUNC(API_ClockParentSet)
SYMBOL_ITEM_FUNC(API_ClockProviderAdd)
SYMBOL_ITEM_FUNC(API_ClockRateGet)
SYMBOL_ITEM_FUNC(API_ClockRateRound)
SYMBOL_ITEM_FUNC(API_ClockRateSet)
SYMBOL_ITEM_FUNC(API_ClockRegister)
SYMBOL_ITEM_FUNC(API_ClockSimpleGet)
SYMBOL_ITEM_FUNC(API_ClockDividerRegister)
SYMBOL_ITEM_FUNC(API_ClockFixedFactorRegister)
SYMBOL_ITEM_FUNC(API_ClockFixedRateRegister)
SYMBOL_ITEM_FUNC(API_ClockGateRegister)
SYMBOL_ITEM_FUNC(API_ClockMuxRegister)
...
SYMBOL_ITEM_FUNC(API_GpioCtrlRegister)
SYMBOL_ITEM_FUNC(API_GpioCtrlUnregister)
SYMBOL_ITEM_FUNC(API_GMemDevAdd)
SYMBOL_ITEM_FUNC(API_GMemDevStatus)
...
SYMBOL_ITEM_FUNC(API_I2cAdapterRegister)
SYMBOL_ITEM_FUNC(API_I2cAdapterUnregister)
SYMBOL_ITEM_FUNC(API_I2cBusGet)
SYMBOL_ITEM_FUNC(API_I2cBusInit)
SYMBOL_ITEM_FUNC(API_I2cBusTransfer)
SYMBOL_ITEM_FUNC(API_I2cDevDelete)
SYMBOL_ITEM_FUNC(API_I2cDevRegister)
SYMBOL_ITEM_FUNC(API_I2cDevTransfer)
SYMBOL_ITEM_FUNC(API_I2cDrvRegister)
SYMBOL_ITEM_FUNC(API_I2cDrvUnregister)
SYMBOL_ITEM_FUNC(API_IrqCtrlDevCreate)
SYMBOL_ITEM_FUNC(API_IrqCtrlDevDelete)
SYMBOL_ITEM_FUNC(API_IrqCtrlDevFind)
SYMBOL_ITEM_FUNC(API_IrqCtrlDevtreeNodeMatch)
SYMBOL_ITEM_FUNC(API_IrqCtrlDevtreeTrans)
SYMBOL_ITEM_FUNC(API_IrqCtrlFindVectorByHwIrq)
SYMBOL_ITEM_FUNC(API_IrqCtrlHwIrqMapToVector)
...
SYMBOL_ITEM_FUNC(API_MdioAdapterRegister)
SYMBOL_ITEM_FUNC(API_MdioBusGet)
SYMBOL_ITEM_FUNC(API_MdioBusInit)
SYMBOL_ITEM_FUNC(API_MdioBusRead)
SYMBOL_ITEM_FUNC(API_MdioBusReset)
SYMBOL_ITEM_FUNC(API_MdioBusWrite)
SYMBOL_ITEM_FUNC(API_MdioDevCreate)
SYMBOL_ITEM_FUNC(API_MdioDevDelete)
SYMBOL_ITEM_FUNC(API_MdioDevRead)
SYMBOL_ITEM_FUNC(API_MdioDevRegister)
SYMBOL_ITEM_FUNC(API_MdioDevWrite)
SYMBOL_ITEM_FUNC(API_MdioDrvRegister)
SYMBOL_ITEM_FUNC(API_PhyDevCreate)
SYMBOL_ITEM_FUNC(API_PhyRead)
SYMBOL_ITEM_FUNC(API_PhyWrite)
...
SYMBOL_ITEM_FUNC(API_NvmeDevIoctl)
...
SYMBOL_ITEM_FUNC(API_PinConfigApply)
SYMBOL_ITEM_FUNC(API_PinConfigMapToSetting)
SYMBOL_ITEM_FUNC(API_PinConfigMapValidate)
SYMBOL_ITEM_FUNC(API_PinBind)
SYMBOL_ITEM_FUNC(API_PinCtrlGet)
SYMBOL_ITEM_FUNC(API_PinCtrlGroupSelectorGet)
SYMBOL_ITEM_FUNC(API_PinCtrlMapAdd)
SYMBOL_ITEM_FUNC(API_PinCtrlMapDel)
SYMBOL_ITEM_FUNC(API_PinCtrlPinGetByName)
SYMBOL_ITEM_FUNC(API_PinCtrlStateFind)
SYMBOL_ITEM_FUNC(API_PinCtrlStateSelect)
SYMBOL_ITEM_FUNC(API_PinCtrlDescBuild)
SYMBOL_ITEM_FUNC(API_PinCtrlDevCreate)
SYMBOL_ITEM_FUNC(API_PinCtrlDevGetByDevtreeNode)
SYMBOL_ITEM_FUNC(API_PinCtrlGpioFree)
SYMBOL_ITEM_FUNC(API_PinCtrlGpioRangeAdd)
SYMBOL_ITEM_FUNC(API_PinCtrlGpioRangeRemove)
SYMBOL_ITEM_FUNC(API_PinCtrlGpioRequest)
SYMBOL_ITEM_FUNC(API_PinCtrlPinDescDel)
SYMBOL_ITEM_FUNC(API_PinCtrlPinDescGet)
SYMBOL_ITEM_FUNC(API_PinMuxDisable)
SYMBOL_ITEM_FUNC(API_PinMuxEnable)
SYMBOL_ITEM_FUNC(API_PinMuxMapToSetting)
SYMBOL_ITEM_FUNC(API_PinMuxMapValidate)
...
SYMBOL_ITEM_FUNC(getentropy)
SYMBOL_ITEM_FUNC(getrandom)
...
SYMBOL_ITEM_FUNC(API_SpiBusGet)
SYMBOL_ITEM_FUNC(API_SpiBusInit)
SYMBOL_ITEM_FUNC(API_SpiCtrlRegister)
SYMBOL_ITEM_FUNC(API_SpiCtrlUnregister)
SYMBOL_ITEM_FUNC(API_SpiDevDelete)
SYMBOL_ITEM_FUNC(API_SpiDevRegister)
SYMBOL_ITEM_FUNC(API_SpiDevSetup)
SYMBOL_ITEM_FUNC(API_SpiDevTransfer)
SYMBOL_ITEM_FUNC(API_SpiDrvRegister)
SYMBOL_ITEM_FUNC(API_SpiDrvUnregister)
SYMBOL_ITEM_FUNC(API_SpiRead)
SYMBOL_ITEM_FUNC(API_SpiW8R16)
SYMBOL_ITEM_FUNC(API_SpiW8R8)
SYMBOL_ITEM_FUNC(API_SpiWrite)
SYMBOL_ITEM_FUNC(API_SpiWriteThenRead)
...
SYMBOL_ITEM_FUNC(API_RegulatorCurrentLimitGet)
SYMBOL_ITEM_FUNC(API_RegulatorCurrentLimitSet)
SYMBOL_ITEM_FUNC(API_RegulatorDisable)
SYMBOL_ITEM_FUNC(API_RegulatorEnable)
SYMBOL_ITEM_FUNC(API_RegulatorGet)
SYMBOL_ITEM_FUNC(API_RegulatorInit)
SYMBOL_ITEM_FUNC(API_RegulatorIsEnabled)
SYMBOL_ITEM_FUNC(API_RegulatorRegister)
SYMBOL_ITEM_FUNC(API_RegulatorVoltageGet)
SYMBOL_ITEM_FUNC(API_RegulatorVoltageSet)
SYMBOL_ITEM_FUNC(API_SystemHwInfoPrint)
SYMBOL_ITEM_FUNC(API_SystemLogoPrint)
SYMBOL_ITEM_FUNC(API_DWatchDevCreate)
SYMBOL_ITEM_FUNC(API_DWatchDrvInstall)
SYMBOL_ITEM_FUNC(dwatch)
SYMBOL_ITEM_FUNC(dwatchDevDeleteHook)
SYMBOL_ITEM_FUNC(dwatchDevNotifyHook)
...
SYMBOL_ITEM_FUNC(posix_fadvise)
SYMBOL_ITEM_FUNC(posix_fallocate)
...
SYMBOL_ITEM_FUNC(API_IosDrvGetFeatures)
...
SYMBOL_ITEM_FUNC(_doSigEventVmmAbort)
...
SYMBOL_ITEM_FUNC(__sysperfThread)
...
SYMBOL_ITEM_FUNC(_Znam)
SYMBOL_ITEM_FUNC(_Znwm)
...
SYMBOL_ITEM_FUNC(API_DeviceTreeDefaultPopulate)
SYMBOL_ITEM_FUNC(API_DeviceTreeDevEarlyInit)
SYMBOL_ITEM_FUNC(API_DeviceTreeDevGetMatchData)
SYMBOL_ITEM_FUNC(API_DeviceTreeDevGetMatchTable)
SYMBOL_ITEM_FUNC(API_DeviceTreeDevPopulate)
SYMBOL_ITEM_FUNC(API_DeviceTreeDrvMatchDev)
SYMBOL_ITEM_FUNC(API_DeviceTreeIsCompatible)
SYMBOL_ITEM_FUNC(API_DeviceTreeIrqCountGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeIrqFindParent)
SYMBOL_ITEM_FUNC(API_DeviceTreeIrqGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeIrqOneParse)
SYMBOL_ITEM_FUNC(API_DeviceTreeIrqRawParse)
SYMBOL_ITEM_FUNC(API_DeviceTreeIrqToResouceTable)
SYMBOL_ITEM_FUNC(API_DeviceTreeIrqToResource)
SYMBOL_ITEM_FUNC(API_DeviceTreeClockGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeClockGetByName)
SYMBOL_ITEM_FUNC(API_DeviceTreeParentClockNameGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeGpioCtrlRegister)
SYMBOL_ITEM_FUNC(API_DeviceTreeGpioCtrlRemove)
SYMBOL_ITEM_FUNC(API_DeviceTreeGpioNamedCountGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeGpioNamedGpioGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeGpioPinRangeAdd)
SYMBOL_ITEM_FUNC(API_DeviceTreeGpioPinRangeRemove)
SYMBOL_ITEM_FUNC(API_DeviceTreePinCtrlDevGet)
SYMBOL_ITEM_FUNC(API_DeviceTreePinCtrlMapsCreate)
SYMBOL_ITEM_FUNC(API_DeviceTreePinCtrlMapsFree)
SYMBOL_ITEM_FUNC(API_DeviceTreeAliasIdGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeHighLevelInit)
SYMBOL_ITEM_FUNC(API_DeviceTreeKernelStartParamGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeKernelVmmParamGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeLowLevelInit)
SYMBOL_ITEM_FUNC(API_DeviceTreeAddressGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeAddressIoremap)
SYMBOL_ITEM_FUNC(API_DeviceTreeAddressTranslate)
SYMBOL_ITEM_FUNC(API_DeviceTreeFindAllNodes)
SYMBOL_ITEM_FUNC(API_DeviceTreeFindNodeOptsByPath)
SYMBOL_ITEM_FUNC(API_DeviceTreeNAddrCells)
SYMBOL_ITEM_FUNC(API_DeviceTreeNextChildGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeNSizeCells)
SYMBOL_ITEM_FUNC(API_DeviceTreeRegAddressGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeResourceGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeMdioDevFind)
SYMBOL_ITEM_FUNC(API_DeviceTreeMdioDevRegister)
SYMBOL_ITEM_FUNC(API_DeviceTreeMdioRegister)
SYMBOL_ITEM_FUNC(API_DeviceTreeI2cAdapterRegister)
SYMBOL_ITEM_FUNC(API_DeviceTreeI2cDevRegister)
SYMBOL_ITEM_FUNC(API_DeviceTreeSpiCtrlRegister)
SYMBOL_ITEM_FUNC(API_DeviceTreeSpiDevRegister)
SYMBOL_ITEM_FUNC(API_DeviceTreePciBusRangeParse)
SYMBOL_ITEM_FUNC(API_DeviceTreePciHostBridgeResourcesGet)
SYMBOL_ITEM_FUNC(API_DeviceTreePciRangesParse)
SYMBOL_ITEM_FUNC(API_DeviceTreeFindNodeByPhandle)
SYMBOL_ITEM_FUNC(API_DeviceTreePhandleCountWithArgs)
SYMBOL_ITEM_FUNC(API_DeviceTreePhandleIteratorInit)
SYMBOL_ITEM_FUNC(API_DeviceTreePhandleIteratorNext)
SYMBOL_ITEM_FUNC(API_DeviceTreePhandleParse)
SYMBOL_ITEM_FUNC(API_DeviceTreePhandleParseFixedArgs)
SYMBOL_ITEM_FUNC(API_DeviceTreePhandleParseWithArgs)
SYMBOL_ITEM_FUNC(API_DeviceTreeModaliasGet)
SYMBOL_ITEM_FUNC(API_DeviceTreeNodeIsOkay)
SYMBOL_ITEM_FUNC(API_DeviceTreeNodeIsOkayByOffset)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyBoolRead)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyFind)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyGet)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyStringCount)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyStringHelperRead)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyStringIndexRead)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyStringMatch)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyStringNext)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyStringRead)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyU32ArrayRead)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyU32IndexRead)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyU32Next)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyU32Read)
SYMBOL_ITEM_FUNC(API_DeviceTreePropertyU32VaraiableArrayRead)
SYMBOL_ITEM_FUNC(fdtdec_get_int)
SYMBOL_ITEM_FUNC(fdtdec_get_uint)
SYMBOL_ITEM_FUNC(fdt_get_named_resource)
SYMBOL_ITEM_FUNC(fdt_get_resource)
SYMBOL_ITEM_FUNC(fdtdec_add_aliases_for_id)
SYMBOL_ITEM_FUNC(fdtdec_check_fdt)
SYMBOL_ITEM_FUNC(fdtdec_decode_display_timing)
SYMBOL_ITEM_FUNC(fdtdec_find_aliases_for_id)
SYMBOL_ITEM_FUNC(fdtdec_get_addr)
SYMBOL_ITEM_FUNC(fdtdec_get_addr_size)
SYMBOL_ITEM_FUNC(fdtdec_get_addr_size_auto_noparent)
SYMBOL_ITEM_FUNC(fdtdec_get_addr_size_auto_parent)
SYMBOL_ITEM_FUNC(fdtdec_get_addr_size_fixed)
SYMBOL_ITEM_FUNC(fdtdec_get_alias_highest_id)
SYMBOL_ITEM_FUNC(fdtdec_get_alias_seq)
SYMBOL_ITEM_FUNC(fdtdec_get_bool)
SYMBOL_ITEM_FUNC(fdtdec_get_byte_array)
SYMBOL_ITEM_FUNC(fdtdec_get_child_count)
SYMBOL_ITEM_FUNC(fdtdec_get_chosen_node)
SYMBOL_ITEM_FUNC(fdtdec_get_chosen_prop)
SYMBOL_ITEM_FUNC(fdtdec_get_compatible)
SYMBOL_ITEM_FUNC(fdtdec_get_config_bool)
SYMBOL_ITEM_FUNC(fdtdec_get_config_int)
SYMBOL_ITEM_FUNC(fdtdec_get_config_string)
SYMBOL_ITEM_FUNC(fdtdec_get_int_array)
SYMBOL_ITEM_FUNC(fdtdec_get_int_array_count)
SYMBOL_ITEM_FUNC(fdtdec_get_is_enabled)
SYMBOL_ITEM_FUNC(fdtdec_get_number)
SYMBOL_ITEM_FUNC(fdtdec_get_uint64)
SYMBOL_ITEM_FUNC(fdtdec_locate_array)
SYMBOL_ITEM_FUNC(fdtdec_locate_byte_array)
SYMBOL_ITEM_FUNC(fdtdec_lookup)
SYMBOL_ITEM_FUNC(fdtdec_lookup_phandle)
SYMBOL_ITEM_FUNC(fdtdec_next_alias)
SYMBOL_ITEM_FUNC(fdtdec_next_compatible)
SYMBOL_ITEM_FUNC(fdtdec_next_compatible_subnode)
SYMBOL_ITEM_FUNC(fdtdec_parse_phandle_with_args)
SYMBOL_ITEM_FUNC(fdtdec_prepare_fdt)
SYMBOL_ITEM_FUNC(fdtdec_setup)
SYMBOL_ITEM_FUNC(fdt_address_cells)
SYMBOL_ITEM_FUNC(fdt_appendprop_addrrange)
SYMBOL_ITEM_FUNC(fdt_size_cells)
SYMBOL_ITEM_FUNC(fdt_create_empty_tree)
SYMBOL_ITEM_FUNC(fdt_overlay_apply)
SYMBOL_ITEM_FUNC(fdt_check_full)
SYMBOL_ITEM_FUNC(fdt_find_max_phandle)
SYMBOL_ITEM_FUNC(fdt_first_property_offset)
SYMBOL_ITEM_FUNC(fdt_generate_phandle)
SYMBOL_ITEM_FUNC(fdt_get_alias)
SYMBOL_ITEM_FUNC(fdt_get_alias_namelen)
SYMBOL_ITEM_FUNC(fdt_get_mem_rsv)
SYMBOL_ITEM_FUNC(fdt_get_name)
SYMBOL_ITEM_FUNC(fdt_get_path)
SYMBOL_ITEM_FUNC(fdt_get_phandle)
SYMBOL_ITEM_FUNC(fdt_get_property)
SYMBOL_ITEM_FUNC(fdt_get_property_by_offset)
SYMBOL_ITEM_FUNC(fdt_get_property_namelen)
SYMBOL_ITEM_FUNC(fdt_get_string)
SYMBOL_ITEM_FUNC(fdt_getprop)
SYMBOL_ITEM_FUNC(fdt_getprop_by_offset)
SYMBOL_ITEM_FUNC(fdt_getprop_namelen)
SYMBOL_ITEM_FUNC(fdt_next_property_offset)
SYMBOL_ITEM_FUNC(fdt_node_check_compatible)
SYMBOL_ITEM_FUNC(fdt_node_depth)
SYMBOL_ITEM_FUNC(fdt_node_offset_by_compatible)
SYMBOL_ITEM_FUNC(fdt_node_offset_by_phandle)
SYMBOL_ITEM_FUNC(fdt_node_offset_by_prop_value)
SYMBOL_ITEM_FUNC(fdt_num_mem_rsv)
SYMBOL_ITEM_FUNC(fdt_parent_offset)
SYMBOL_ITEM_FUNC(fdt_path_offset)
SYMBOL_ITEM_FUNC(fdt_path_offset_namelen)
SYMBOL_ITEM_FUNC(fdt_string)
SYMBOL_ITEM_FUNC(fdt_stringlist_contains)
SYMBOL_ITEM_FUNC(fdt_stringlist_count)
SYMBOL_ITEM_FUNC(fdt_stringlist_get)
SYMBOL_ITEM_FUNC(fdt_stringlist_search)
SYMBOL_ITEM_FUNC(fdt_subnode_offset)
SYMBOL_ITEM_FUNC(fdt_subnode_offset_namelen)
SYMBOL_ITEM_FUNC(fdt_supernode_atdepth_offset)
SYMBOL_ITEM_FUNC(fdt_add_mem_rsv)
SYMBOL_ITEM_FUNC(fdt_add_subnode)
SYMBOL_ITEM_FUNC(fdt_add_subnode_namelen)
SYMBOL_ITEM_FUNC(fdt_appendprop)
SYMBOL_ITEM_FUNC(fdt_del_mem_rsv)
SYMBOL_ITEM_FUNC(fdt_del_node)
SYMBOL_ITEM_FUNC(fdt_delprop)
SYMBOL_ITEM_FUNC(fdt_open_into)
SYMBOL_ITEM_FUNC(fdt_pack)
SYMBOL_ITEM_FUNC(fdt_set_name)
SYMBOL_ITEM_FUNC(fdt_setprop)
SYMBOL_ITEM_FUNC(fdt_setprop_placeholder)
SYMBOL_ITEM_FUNC(fdt_strerror)
SYMBOL_ITEM_FUNC(fdt_add_reservemap_entry)
SYMBOL_ITEM_FUNC(fdt_begin_node)
SYMBOL_ITEM_FUNC(fdt_create)
SYMBOL_ITEM_FUNC(fdt_end_node)
SYMBOL_ITEM_FUNC(fdt_finish)
SYMBOL_ITEM_FUNC(fdt_finish_reservemap)
SYMBOL_ITEM_FUNC(fdt_property)
SYMBOL_ITEM_FUNC(fdt_property_placeholder)
SYMBOL_ITEM_FUNC(fdt_resize)
SYMBOL_ITEM_FUNC(fdt_node_end_offset_)
SYMBOL_ITEM_FUNC(fdt_nop_node)
SYMBOL_ITEM_FUNC(fdt_nop_property)
SYMBOL_ITEM_FUNC(fdt_setprop_inplace)
SYMBOL_ITEM_FUNC(fdt_setprop_inplace_namelen_partial)
SYMBOL_ITEM_FUNC(fdt_check_header)
SYMBOL_ITEM_FUNC(fdt_check_node_offset_)
SYMBOL_ITEM_FUNC(fdt_check_prop_offset_)
SYMBOL_ITEM_FUNC(fdt_find_string_)
SYMBOL_ITEM_FUNC(fdt_first_subnode)
SYMBOL_ITEM_FUNC(fdt_header_size_)
SYMBOL_ITEM_FUNC(fdt_move)
SYMBOL_ITEM_FUNC(fdt_next_node)
SYMBOL_ITEM_FUNC(fdt_next_subnode)
SYMBOL_ITEM_FUNC(fdt_next_tag)
SYMBOL_ITEM_FUNC(fdt_offset_ptr)
SYMBOL_ITEM_FUNC(fdt_ro_probe_)
SYMBOL_ITEM_FUNC(bspCpuLogic2Hetrcc)
...
SYMBOL_ITEM_FUNC(arm64EL2SwitchEL1)
SYMBOL_ITEM_FUNC(arm64SwitchToEl1)
SYMBOL_ITEM_FUNC(arm64VfpV4HwInit)
SYMBOL_ITEM_FUNC(arm64VfpV4El2HwInit)
SYMBOL_ITEM_FUNC(archMpCur)
SYMBOL_ITEM_FUNC(archMpInt)
SYMBOL_ITEM_FUNC(arm64MpidrGet)
SYMBOL_ITEM_FUNC(bspSio16c550SetHighBaud)
...
SYMBOL_ITEM_OBJ(_K_hcccpuTable)
...
SYMBOL_ITEM_OBJ(_G_sysperfparam)
SYMBOL_ITEM_OBJ(_G_pdtnAliases)
SYMBOL_ITEM_OBJ(_G_pdtnRoot)
SYMBOL_ITEM_OBJ(_G_ppdtnPhandleCache)
SYMBOL_ITEM_OBJ(_G_uiPhandleCacheMask)
