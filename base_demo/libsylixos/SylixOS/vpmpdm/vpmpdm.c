...
#define __VP_PATCH_VERSION      "2.2.1" /* vp patch version */
...
void* libm_import_ceil(void)
{
    /* import symbol ceil, rint, __fpclassifyd, __fpclassifyf to avoid optimization */
    return  (void *)((unsigned long)ceil +
                     (unsigned long)rint +
                     (unsigned long)__fpclassifyd +
                     (unsigned long)__fpclassifyf);
}
