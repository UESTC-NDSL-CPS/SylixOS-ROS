...
#define ARCH_PPC_SPEFSCR_EXC_MASK \
    (ARCH_PPC_SPEFSCR_SOVH  | \
     ARCH_PPC_SPEFSCR_OVH   | \
     ARCH_PPC_SPEFSCR_FINVH | \
     ARCH_PPC_SPEFSCR_FDBZH | \
     ARCH_PPC_SPEFSCR_FUNFH | \
     ARCH_PPC_SPEFSCR_FOVFH | \
     ARCH_PPC_SPEFSCR_FINVS | \
     ARCH_PPC_SPEFSCR_FDBZS | \
     ARCH_PPC_SPEFSCR_FUNFS | \
     ARCH_PPC_SPEFSCR_FOVFS | \
     ARCH_PPC_SPEFSCR_SOV   | \
     ARCH_PPC_SPEFSCR_OV    | \
     ARCH_PPC_SPEFSCR_FINV  | \
     ARCH_PPC_SPEFSCR_FDBZ  | \
     ARCH_PPC_SPEFSCR_FUNF  | \
     ARCH_PPC_SPEFSCR_FOVF)
