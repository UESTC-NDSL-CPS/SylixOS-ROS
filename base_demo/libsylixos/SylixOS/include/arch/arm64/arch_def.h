...
#define FPCR_RMode_RN               (0 << FPCR_RMode_SHIFT)
#define FPCR_RMode_RP               (1 << FPCR_RMode_SHIFT)
#define FPCR_RMode_RM               (2 << FPCR_RMode_SHIFT)
#define FPCR_RMode_RZ               (3 << FPCR_RMode_SHIFT)
#define FPCR_Stride_SHIFT           (20)
#define FPCR_FZ16                   (1 << 19)
#define FPCR_Len_SHIFT              (16)
#define FPCR_IDE                    (1 << 16)
#define FPCR_EBF                    (1 << 13)
...
#define ISS_FPE_IDF                 (1 << 7)
#define ISS_FPE_IXF                 (1 << 4)
#define ISS_FPE_UFF                 (1 << 3)
#define ISS_FPE_OFF                 (1 << 2)
#define ISS_FPE_DZF                 (1 << 1)
#define ISS_FPE_IOF                 (1 << 0)

/*********************************************************************************************************
  ISS encoding for an exception from a Data Abort
*********************************************************************************************************/

#define ISS_DAE_DFSC_MASK           (0x3f << 0)
#define ISS_DAE_DFSC_ALIGN          (0x21 << 0)
#define ISS_DAE_DFSC_L3PERM         (0xf  << 0)
#define ISS_DAE_WNR                 (1    << 6)
