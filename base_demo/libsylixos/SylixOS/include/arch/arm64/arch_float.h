...
#define FPU_OFFSET_FPSR         (FPU_OFFSET_REG_HI(FPU_REG_NR))         /*  FPSR 偏移                   */
#define FPU_OFFSET_FPCR         (FPU_OFFSET_FCR + 4)                    /*  FPCR 偏移                   */
...
struct arch_fpu_ctx {
    ARCH_FPU_REG        FPUCTX_uiDreg[FPU_REG_NR];                      /*  FPU 通用寄存器  Q0 ~ Q32    */
    UINT32              FPUCTX_uiFpsr;                                  /*  FPU 状态寄存器              */
