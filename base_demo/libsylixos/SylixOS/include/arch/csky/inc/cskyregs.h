...
#define FESR_ILLE                          (1 << 16)                    /* Illegal instruction          */
#define FESR_FEC                           (1 << 7)                     /* Input float-point exception  */
#define FESR_IDC                           (1 << 5)                     /* Input denormalized exception */
#define FESR_IXC                           (1 << 4)                     /* Inexact exception            */
#define FESR_UFC                           (1 << 3)                     /* Underflow exception          */
#define FESR_OFC                           (1 << 2)                     /* Overflow exception           */
#define FESR_DZC                           (1 << 1)                     /* Divide by zero exception     */
#define FESR_IOC                           (1 << 0)                     /* Invalid operation exception  */
