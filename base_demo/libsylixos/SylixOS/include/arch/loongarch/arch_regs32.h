...
**
** 描        述: LoongArch32 寄存器相关.
*********************************************************************************************************/

#ifndef __LOONGARCH_ARCH_REGS32_H
#define __LOONGARCH_ARCH_REGS32_H
...
#define ARCH_REG_CTX_GET_STACK(ctx) ((PVOID)(ctx)->REG_ulReg[REG_SP])

#endif                                                                  /*  !defined(__ASSEMBLY__)      */
#endif                                                                  /*  __LOONGARCH_ARCH_REGS32_H   */
/*********************************************************************************************************
  END
*********************************************************************************************************/
