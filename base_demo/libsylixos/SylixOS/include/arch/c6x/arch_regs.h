...
#define ARCH_REG_CTX_GET_PC(ctx)    ((PVOID)(ctx)->REG_uiIrp)
#define ARCH_REG_CTX_GET_FRAME(ctx) ((PVOID)(ctx)->REG_uiFp)
#define ARCH_REG_CTX_GET_STACK(ctx) ((PVOID)(ctx)->REG_uiSp)
