...
LW_API INT    vprocSecRegionGet(pid_t pid, UINT *puiSecReg);
LW_API INT    vprocSecRegionSet(pid_t pid, UINT uiSecReg);

LW_API UINT   vprocSecRegionGetCur(VOID);
LW_API INT    vprocSecRegionSetCur(UINT  uiSecReg);
