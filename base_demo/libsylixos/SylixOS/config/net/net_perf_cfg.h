...
#define LW_CFG_LWIP_MEM_TLSF_ASSERT     1                               /*  是否需要 tlsf 断言          */
...
#define LW_CFG_LWIP_TCP_MAXRTX          6                               /*  TCP 最大重传数, 1 ~ 12      */
#define LW_CFG_LWIP_TCP_SYNMAXRTX       4                               /*  最大 SYN 重传数, 1 ~ 12     */
#define LW_CFG_LWIP_TCP_RTO_INIT        3000                            /*  RTO 初始值 (ms) 推荐 3000   */
