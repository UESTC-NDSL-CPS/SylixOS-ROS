...
#define LW_CFG_MAX_EVENTS                       5000    /*  系统使用事件的最大个数              < 65535 */
...
#define LW_CFG_MAX_INTER_SRC                    512     /*  系统使用中断向量表大小,中断源数量   <  9999 */
...
#define LW_CFG_MONITOR_TRACE_INT_EN             0       /*  是否允许系统提供监控跟踪中断 (效率较低)     */
