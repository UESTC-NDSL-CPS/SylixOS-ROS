...
#define SDHOST_CAP_HS400ES              (1 << 10)                   /*  支持 HS400ES 模式               */
...
#define SDHOST_EXTOPT_DIRECT_THRESHOLD_SET      12                  /*  设置高速设备直接读写阀值        */
#define SDHOST_EXTOPT_DIRECT_THRESHOLD_GET      13                  /*  获得高速设备直接读写阀值        */

#define SDHOST_EXTOPT_META_CACHE_FLUSH_SET      18                  /*  设置 FIOSYNCMETA 是否刷回磁盘   */
#define SDHOST_EXTOPT_META_CACHE_FLUSH_GET      19                  /*  获得 FIOSYNCMETA 是否刷回磁盘   */
