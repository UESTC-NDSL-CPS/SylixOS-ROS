                            ...
                            LW_SDDEV_EXT_CSD  *psdextcsd)
{
    ...
    if (uiExtCsdRev >= 6) {
        ...
        psdextcsd->DEVEXTCSD_uiCacheSize   = (pucExtCsd[EXT_CSD_CACHE_SIZE + 0] << 0)  |
                                             (pucExtCsd[EXT_CSD_CACHE_SIZE + 1] << 8)  |
                                             (pucExtCsd[EXT_CSD_CACHE_SIZE + 2] << 16) |
                                             (pucExtCsd[EXT_CSD_CACHE_SIZE + 3] << 24);
    } else {
