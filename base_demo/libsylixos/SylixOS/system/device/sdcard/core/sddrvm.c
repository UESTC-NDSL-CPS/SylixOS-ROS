...
struct __sdm_host {
    ...
    LONG             SDMHOST_lDirectThreshold;
    LONG             SDMHOST_lMetaCacheFlush;
};
/*********************************************************************************************************
  前置声明
*********************************************************************************************************/
...
LW_API INT   API_SdmHostExtOptSet (PVOID pvSdmHost, INT  iOption, LONG  lArg)
{
    ...
    case SDHOST_EXTOPT_DIRECT_THRESHOLD_SET:
        psdmhost->SDMHOST_lDirectThreshold = lArg;
        break;

    case SDHOST_EXTOPT_META_CACHE_FLUSH_SET:
        psdmhost->SDMHOST_lMetaCacheFlush  = lArg;
        break;
...
LW_API INT   API_SdmHostExtOptGet (PLW_SDCORE_DEVICE psdcoredev, INT  iOption, LONG  lArg)
{
    ...
    case SDHOST_EXTOPT_DIRECT_THRESHOLD_GET:
        *(LONG *)lArg = psdmhost->SDMHOST_lDirectThreshold;
        break;

    case SDHOST_EXTOPT_META_CACHE_FLUSH_GET:
        *(LONG *)lArg = psdmhost->SDMHOST_lMetaCacheFlush;
        break;
...
static VOID  __sdmHostExtOptInit (__SDM_HOST  *psdmhost)
{
    ...
    psdmhost->SDMHOST_lMetaCacheFlush = 0;
}
/*********************************************************************************************************
** 函数名称: __sdmDrvExist
