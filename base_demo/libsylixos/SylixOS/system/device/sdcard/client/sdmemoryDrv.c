...
static INT  __sdmemDevCreate (SD_DRV *psddrv, PLW_SDCORE_DEVICE psdcoredev, VOID **ppvDevPriv)
{
    ...
    API_SdmHostExtOptGet(psdcoredev, SDHOST_EXTOPT_DIRECT_THRESHOLD_GET, (LONG)&lDirectThreshold);
    ...
    dcattrl.DCATTR_stDirectThreshold = lDirectThreshold;
