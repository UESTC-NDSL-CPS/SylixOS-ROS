...
#define SDHCI_HCTRL_UHS_HS400           0x0005                          /*  非标准规定                  */
...
#define SDHCI_QUIRK_FLG_FORCE_HS400ES                         (1 << 21) /*  强制使用 HS400ES 模式       */
...
struct _sdhci_quirk_op {
    ...
    INT     (*SDHCIQOP_pfuncHs400EnhancedStrobe)                        /*  设置 HS400ES                */
            (
            PLW_SDHCI_HOST_ATTR  psdhcihostattr,
            BOOL                 bIsOn
            );
    INT     (*SDHCIQOP_pfuncVoltageSet)                                 /*  设置信号电压                */
            (
            PLW_SDHCI_HOST_ATTR  psdhcihostattr,
            UINT32               uiVoltage
            );
    INT     (*SDHCIQOP_pfuncTimingSet)                                  /*  设置时序                    */
            (
            PLW_SDHCI_HOST_ATTR  psdhcihostattr,
            UINT32               uiTiming
            );
