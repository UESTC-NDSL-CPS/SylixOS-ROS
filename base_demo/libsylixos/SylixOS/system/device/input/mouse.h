...
#define MSE_DEVICE_INFO_STR_SZ     48

typedef struct mouse_device_info {
    CHAR                vendor[MSE_DEVICE_INFO_STR_SZ];                 /*  vendor                      */
    CHAR                product[MSE_DEVICE_INFO_STR_SZ];                /*  product                     */
    CHAR                serial[MSE_DEVICE_INFO_STR_SZ];                 /*  serial number               */
} mouse_device_info;
...
#define MSE_CTL_GET_DEVICE_INFO     _IOR('m', 1, mouse_device_info)     /*  get mouse device info       */
