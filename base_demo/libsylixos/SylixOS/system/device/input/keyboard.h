...
#define KBD_DEVICE_INFO_STR_SZ     48

typedef struct keyboard_device_info {
    CHAR                vendor[KBD_DEVICE_INFO_STR_SZ];                 /*  vendor                      */
    CHAR                product[KBD_DEVICE_INFO_STR_SZ];                /*  product                     */
    CHAR                serial[KBD_DEVICE_INFO_STR_SZ];                 /*  serial number               */
...
#define KBD_CTL_GET_DEVICE_INFO     _IOR('k', 2, keyboard_device_info)  /*  get keyboard device info    */
