...
#define NVME_BLK_NAME_MAX                   (64 + 1)                    /* 块设备名称最大值             */
...
#define NVME_CACHE_BURST_RD                 256                         /* 读猝发参数                   */
#define NVME_CACHE_BURST_WR                 256                         /* 写猝发参数                   */
#define NVME_DRIVE_DISKCACHE_MSG_COUNT      16                          /* 磁盘缓冲消息数量             */
#define NVME_DRIVE_DISKCACHE_PARALLEL_EN    LW_TRUE                     /* 磁盘缓冲是否使能并行操作     */
#define NVME_CACHE_SIZE                     (256 * LW_CFG_KB_SIZE)      /* 磁盘缓存大小                 */
                                                                        /* 可根据实测数据进行更改       */
/*********************************************************************************************************
  控制器参数
*********************************************************************************************************/
