...
/*********************************************************************************************************
  设备操作命令
*********************************************************************************************************/
#define NVME_DEV_IOCTL_CACHE_FLUSH_GET      0x200                       /* 获取设备 syncmate flush 使能 */
#define NVME_DEV_IOCTL_CACHE_FLUSH_SET      0x201                       /* 设置设备 syncmate flush 使能 */
/*********************************************************************************************************
  NVMe 控制器寄存器
*********************************************************************************************************/
...
typedef struct nvme_queue_cb {
    ...
    SYNC_CMD_INFO_HANDLE    NVMEQUEUE_hCmdInfo[NVME_CMD_DEPTH_MAX];     /* 命令同步信息                 */
...
#if NVME_CACHE_EN > 0
    INT                     NVMEDEV_iCacheFlush;                        /* FIOSYNCMETA 是否 flush 磁盘  */
#endif
} NVME_DEV_CB;
...
/*********************************************************************************************************
  函数声明
*********************************************************************************************************/
LW_API INT                  API_NvmeDevIoctl(NVME_DEV_HANDLE hDev, INT iCmd, LONG lArg);
