...
/*********************************************************************************************************
  设备操作命令
*********************************************************************************************************/
#define AHCI_DEV_IOCTL_CACHE_FLUSH_GET      0x200                       /* 获取设备 syncmate flush 使能 */
#define AHCI_DEV_IOCTL_CACHE_FLUSH_SET      0x201                       /* 设置设备 syncmate flush 使能 */
/*********************************************************************************************************
  设备类型
*********************************************************************************************************/
...
/*********************************************************************************************************
  SMART 命令 (Note that some are obsolete as of ATA-7)
*********************************************************************************************************/
...
/*********************************************************************************************************
  CDROM 命令 (Multimedia Device Command Set and SCSI Device Primary Command Set)
...
typedef struct ahci_dev_cb {
    ...
    INT                 AHCIDEV_iCacheFlush;                            /* FIOSYNCMETA 是否 flush 磁盘  */
} AHCI_DEV_CB;
