...
typedef struct {
    ...
    ULONG                         DEVHDR_ulDWatchs;                     /*  DWatch 监控数量             */
} LW_DEV_HDR;
...
#define LW_DRV_FEATURE_UNLINK_ON_OPEN   0x01                            /*  允许删除被打开的文件        */
#define LW_DRV_FEATURE_DWATCH           0x02                            /*  支持 DWATCH                 */
...
#define LW_FD_ENTRY_SET_FD_NODE(pfdentry, pfdnode)  ((pfdentry)->FDENTRY_lValue = (LONG)pfdnode)
#define LW_FD_ENTRY_CLEAR_FD_NODE(pfdentry)         ((pfdentry)->FDENTRY_lValue = (LONG)NULL)
