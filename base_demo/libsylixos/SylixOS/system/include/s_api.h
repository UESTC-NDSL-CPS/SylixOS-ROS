...
LW_API INT              posix_fadvise(INT iFd, off_t oftOffet, off_t oftLen, INT iAdvice);
LW_API INT              posix_fallocate(INT iFd, off_t oftOffset, off_t oftLen);
...
#define iosGetDrvLicense                         API_IoGetDrvLicense
#define iosGetDrvAuthor                          API_IoGetDrvAuthor
#define iosGetDrvDescrption                      API_IoGetDrvDescription
