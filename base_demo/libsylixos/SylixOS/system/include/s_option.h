...
#define FIOALLOCATE         LW_OSIOD('f', 36, off_t[2])         /* allocate file space                  */
...
#endif
                                                                /* 0: Default                           */
                                                                /* 1: Single file loose merger          */
                                                                /* 2: Current volume loose merger       */
#define FIOGETFSTRANS       LW_OSIOR('f', 73, INT)              /* Get file system transaction mode     */
#define FIOSETFSTRANS       LW_OSIOD('f', 74, INT)              /* Set file system transaction mode     */

#define FIOFSTYPE           LW_OSIOR('f', 80, LW_PATHB)         /* get file system type string          */
