...
#if LW_CFG_MONITOR_TRACE_INT_EN > 0
    MONITOR_EVT_LONG2(MONITOR_EVENT_ID_INT, MONITOR_EVENT_INT_ENTER, ulVector, LW_NULL, LW_NULL);
#endif
...
#if LW_CFG_MONITOR_TRACE_INT_EN > 0
    MONITOR_EVT_LONG2(MONITOR_EVENT_ID_INT, MONITOR_EVENT_INT_EXIT, ulVector, LW_NULL, LW_NULL);
#endif
