...
VOID  __resAddFileHook(PLW_RESOURCE_RAW    presraw,
                       ...
                       PVOID               pvFile,
                       BOOL                bClose,
                       BOOL                bFlush);                     /*  创建一个 FILE 资源          */

VOID  __resDelFileHook(PLW_RESOURCE_RAW    presraw);                    /*  删除一个 FILE 资源          */
...
INT   __resPidReclaimOnlyFile(pid_t  pid, BOOL  bClose, BOOL  bFlush);  /*  仅回收 FILE 资源            */
