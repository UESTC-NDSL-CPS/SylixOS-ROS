...
LW_API ULONG            API_CpuMaxHetrcc(VOID);                         /*  当前系统异构算力最大 ID     */

LW_API ULONG            API_CpuUpMaxHetrcc(VOID);                       /*  当前在线 CPU 异构算力最大 ID*/

LW_API ULONG            API_CpuUpCurHetrcc(ULONG  ulHccId);             /*  获取指定异构算力簇          */
                                                                        /*  当前激活的 CPU 数量         */
#endif                                                                  /*  LW_CFG_SMP_EN > 0           */
...
LW_API ULONG            API_ThreadGetAffinity(LW_OBJECT_HANDLE        ulId, 
                                              ...
                                              PLW_CLASS_CPUSET        pcpuset);
                                                                        /*  获取线程 CPU 亲和度         */
LW_API ULONG            API_ThreadSetHetrcc(LW_OBJECT_HANDLE  ulId,
                                            INT  iMode, ULONG  ulHccId);
                                                                        /*  设置线程算力簇亲和度        */
LW_API ULONG            API_ThreadGetHetrcc(LW_OBJECT_HANDLE  ulId,
                                            INT  *piMode, ULONG  *pulHccId);
                                                                        /*  获取线程算力簇亲和度        */
#endif                                                                  /*  LW_CFG_SMP_EN > 0           */
...
LW_API VOID             API_StackShowEx(pid_t  pid);                    /*  打印指定进程线程堆栈使用信息*/
