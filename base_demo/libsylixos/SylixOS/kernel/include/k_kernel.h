...
**
** 描        述: 这是内核综合头文件库。(特别感谢 Google 代码搜索)
...
2023.05.05  升级版本到 3.0.
2023.06.06  开始支持异构算力调度
            修改项目代号为: Cen-Ci swords(参差剑).
*********************************************************************************************************/
...
#define __SYLIXOS_RELSTR        "Cen-Ci swords"
