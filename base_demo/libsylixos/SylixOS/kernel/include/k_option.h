...
#define LW_OPTION_THREAD_NUMA                           0x00004000      /*  NUMA 簇域线程               */

/*********************************************************************************************************
  THREAD Options for FPU, DSP
*********************************************************************************************************/

#define LW_OPTION_THREAD_FPU_EXC_EN                     0x00001000      /*  使能 FPU 异常               */
#define LW_OPTION_THREAD_DSP_EXC_EN                     0x00002000      /*  使能 DSP 异常               */

/*********************************************************************************************************
  THREAD Options for kernel
*********************************************************************************************************/
...
#define LW_OPTION_VUTEX_SIGNAL_INTER               0x40000000           /*  PendEx EINTR when signal    */
