...
__KERNEL_EXT ULONG                   _K_ulNHetrccs = 1;
...
#endif                                                                  /*  LW_CFG_CPU_ARCH_SMT > 0     */
#if (LW_CFG_SMP_EN > 0) && (LW_CFG_CPU_ARCH_HETRC > 0)
__KERNEL_EXT ULONG                   _K_ulNHetrccs;
#endif                                                                  /*  LW_CFG_CPU_ARCH_HETRC > 0   */
...
#endif                                                                  /*  LW_CFG_CPU_ARCH_SMT > 0     */
#if (LW_CFG_SMP_EN > 0) && (LW_CFG_CPU_ARCH_HETRC > 0)
             LW_CLASS_HCCCPU         _K_hcccpuTable[LW_CFG_MAX_PROCESSORS] LW_CACHE_LINE_ALIGN;
#endif                                                                  /*  LW_CFG_CPU_ARCH_HETRC > 0   */
...
#endif                                                                  /*  LW_CFG_CPU_ARCH_SMT > 0     */
#if (LW_CFG_SMP_EN > 0) && (LW_CFG_CPU_ARCH_HETRC > 0)
__KERNEL_EXT LW_CLASS_HCCCPU         _K_hcccpuTable[LW_CFG_MAX_PROCESSORS];
#endif                                                                  /*  LW_CFG_CPU_ARCH_HETRC > 0   */
