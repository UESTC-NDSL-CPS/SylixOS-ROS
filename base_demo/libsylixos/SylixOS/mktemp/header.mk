...
__OUTDIR          = Debug
__OPPOSITE_OUTDIR = Release
else
__OUTDIR          = Release
__OPPOSITE_OUTDIR = Debug
endif

ifeq ($(MULTI_PLATFORM_BUILD), yes)
SDK_OUTDIR      = build/$(PLATFORM_NAME)/
...
Debug           = $(SDK_OUTDIR)Debug
Release         = $(SDK_OUTDIR)Release
OUTDIR          = $(SDK_OUTDIR)$(__OUTDIR)
Output          = $(OUTDIR)
OPPOSITE_OUTDIR = $(SDK_OUTDIR)$(__OPPOSITE_OUTDIR)
OUTPATH         = $(OUTDIR)
OBJPATH         = $(CUSTOM_OUT_BASE)$(OUTDIR)/obj
DEPPATH         = $(CUSTOM_OUT_BASE)$(OUTDIR)/dep
