...
$(target)_DEPEND_LIB_PATH += $(TOOLCHAIN_LIB_INC)"$(SYLIXOS_BASE_PATH)/libsylixos/$(OPPOSITE_OUTDIR)"

ifeq ($($(target)_USE_CXX), yes)
$(target)_DEPEND_LIB_PATH += $(TOOLCHAIN_LIB_INC)"$(SYLIXOS_BASE_PATH)/libcextern/$(OUTDIR)"
$(target)_DEPEND_LIB_PATH += $(TOOLCHAIN_LIB_INC)"$(SYLIXOS_BASE_PATH)/libcextern/$(OPPOSITE_OUTDIR)"
endif
...
__UNIT_TEST_TARGET         = $(word 4,$(subst $(BIAS),$(SPACE),$(1)))
__UNIT_TEST_STRIP_TARGET   = $(word 5,$(subst $(BIAS),$(SPACE),$(1)))
else
__UNIT_TEST_TARGET         = $(word 2,$(subst $(BIAS),$(SPACE),$(1)))
__UNIT_TEST_STRIP_TARGET   = $(word 3,$(subst $(BIAS),$(SPACE),$(1)))
endif
