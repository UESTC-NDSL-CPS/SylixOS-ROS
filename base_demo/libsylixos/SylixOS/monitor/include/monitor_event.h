...
#define MONITOR_EVT_LONG6(event, sub, arg1, arg2, arg3, arg4, arg5, arg6, addstr)    \
        do {                                                                \
            LW_EVT_LONG6   evt;                                             \
            evt.EVT_lArg[0] = (LONG)arg1;                                   \
            evt.EVT_lArg[1] = (LONG)arg2;                                   \
            ...
            evt.EVT_lArg[3] = (LONG)arg4;                                   \
            evt.EVT_lArg[4] = (LONG)arg5;                                   \
            evt.EVT_lArg[5] = (LONG)arg6;                                   \
            MONITOR_TRACE_EVENT(event, sub,                                 \
                                (CPVOID)&evt, sizeof(evt), addstr);         \
        } while (0)

#define MONITOR_EVT_LONG7(event, sub, arg1, arg2, arg3, arg4, arg5, arg6, arg7, addstr)    \
        do {                                                                \
            LW_EVT_LONG7   evt;                                             \
            evt.EVT_lArg[0] = (LONG)arg1;                                   \
            evt.EVT_lArg[1] = (LONG)arg2;                                   \
            ...
            evt.EVT_lArg[4] = (LONG)arg5;                                   \
            evt.EVT_lArg[5] = (LONG)arg6;                                   \
            evt.EVT_lArg[6] = (LONG)arg7;                                   \
            MONITOR_TRACE_EVENT(event, sub,                                 \
                                (CPVOID)&evt, sizeof(evt), addstr);         \
        } while (0)

#define MONITOR_EVT_LONG8(event, sub, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, addstr)    \
        do {                                                                \
            LW_EVT_LONG8   evt;                                             \
            evt.EVT_lArg[0] = (LONG)arg1;                                   \
            evt.EVT_lArg[1] = (LONG)arg2;                                   \
