...
PCHAR  lib_strerror (INT  iNum)
{
    ...
    case ERROR_KERNEL_LOW_MEMORY:       return  ("Kernel no enough memory");
     ...
     *  thread 
     */
    case ERROR_THREAD_STACKSIZE_LACK:   return  ("No enough stack");
    ...
    case ERROR_THREAD_RESTART_DELAY:    return  ("Thread restart delay");
     ...
     *  system
     */
    case ERROR_SYSTEM_LOW_MEMORY:         return  ("System no enough memory");
