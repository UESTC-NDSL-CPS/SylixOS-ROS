...
INT  _netBridgeInit (VOID)
{
    ...
    API_TShellHelpAdd("netbr",   "add / delete / control net bridge.\n"
                      "eg. netbr show bridge0           (Show all net device in 'bridge0' net bridge)\n"
                      "    netbr addbr bridge0          (Add a net bridge named 'bridge0')\n"
                      "    netbr delbr bridge0          (Delete a net bridge named 'bridge0')\n"
                      "    netbr flush bridge0          (Flush all MAC cache in net bridge named 'bridge0')\n"
                      "    netbr adddev bridge0 ethdev0 (Add a net device in net bridge named 'bridge0')\n"
                      "    netbr deldev bridge0 ethdev0 (Delete a net device from net bridge named 'bridge0')\n"
