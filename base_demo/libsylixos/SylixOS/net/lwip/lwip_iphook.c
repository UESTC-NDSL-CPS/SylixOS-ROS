...
/*********************************************************************************************************
** 函数名称: net_ip_hook_netif_get_secreg
** 功能描述: 获取网卡 security region
** 输　入  : pnetif        网络接口
** 输　出  : security region
** 全局变量:
** 调用模块:
*********************************************************************************************************/
UINT  net_ip_hook_netif_get_secreg (struct netif *pnetif)
{
    return  (pnetif ? netif_get_security(pnetif) : 0);
}
