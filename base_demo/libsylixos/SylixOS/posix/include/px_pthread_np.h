...
/*********************************************************************************************************
  pthread heterogeneous computing cluster
*********************************************************************************************************/
#define PTHREAD_HETRCC_NON_AFFINITY         LW_HETRCC_NON_AFFINITY
#define PTHREAD_HETRCC_WEAK_AFFINITY        LW_HETRCC_WEAK_AFFINITY
#define PTHREAD_HETRCC_STRONG_AFFINITY      LW_HETRCC_STRONG_AFFINITY

LW_API int  pthread_sethetrcc_np(pthread_t  thread, int mode, unsigned int cluster);
LW_API int  pthread_gethetrcc_np(pthread_t  thread, int *mode, unsigned int *cluster);
