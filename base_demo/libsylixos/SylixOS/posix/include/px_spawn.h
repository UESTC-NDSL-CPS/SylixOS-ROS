...
/*********************************************************************************************************
  posix_spawnattr_t extend FPU, DSP flags.
*********************************************************************************************************/

#define POSIX_SPAWN_EXT_FPU_EXC_EN              0x00000100              /*  Enable FPU exception        */
#define POSIX_SPAWN_EXT_DSP_EXC_EN              0x00000200              /*  Enable DSP exception        */

/*********************************************************************************************************
  posix_spawnattr_t extend security flags.
*********************************************************************************************************/

#define POSIX_SPAWN_EXT_SEC_REGION_EN           0x00001000              /*  Security region enable      */
