...
/*********************************************************************************************************
  全局变量定义
*********************************************************************************************************/
X86_CPU_TOPOLOGY        _G_x86CpuTopology = {
    .TOP_uiMaxLProcsCore    = 1,
    .TOP_uiMaxCoresPkg      = 1,
    .TOP_uiMaxLProcsPkg     = 1,
    .TOP_uiNumCores         = 1,
    .TOP_uiNumPkgs          = 1,
    .TOP_uiNumLProcsEnabled = 1,
};                                                                      /*  CPU 拓扑                    */
/*********************************************************************************************************
...
VOID  x86CpuTopologyInit (X86_MP_APIC_DATA  *pMpApicData)
{
    ...
    for (iIndex = 0; iIndex < iNumCpus; iIndex++) {
        ...
        if (iIndex && (pCpuTopology->TOP_aucSmtIds[iIndex] == 0)) {
            ucPhyCoreId++;
        }
        pCpuTopology->TOP_aucPhyCoreIds[iIndex] = ucPhyCoreId;
