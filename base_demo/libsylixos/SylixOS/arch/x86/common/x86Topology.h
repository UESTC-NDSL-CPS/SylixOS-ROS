...
typedef struct {
    ...
    UCHAR           TOP_aucPkgIds[X86_CPUID_MAX_NUM_CPUS];  /*  Package Ids                             */
                                                            /*  SylixOS Physical Core Ids               */
    UCHAR           TOP_aucPhyCoreIds[X86_CPUID_MAX_NUM_CPUS];
 ...
 * LOGICID -> PHYID
 */
#define X86_LOGICID_TO_PHYID(logicid)   (_G_x86CpuTopology.TOP_aucPhyCoreIds[logicid])
 ...
 */
#define X86_LOGICID_IS_HT(logicid)      (_G_x86CpuTopology.TOP_aucSmtIds[logicid])
