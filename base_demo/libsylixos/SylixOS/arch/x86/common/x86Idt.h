...
#define X86_EXCEPT_SPURIOUS                     15                      /*  Spurious Interrupt          */
...
#define X86_EXCEPT_SIMD_FP_ERROR                19                      /*  SIMD FP Exception           */
#define X86_EXCEPT_VIRTUALIZATION_ERROR         20                      /*  Virtualization Exception    */
#define X86_EXCEPT_CONTROL_PROTECTION           21                      /*  No                          */
...
#define X86_EXCEPT_VMM_COMM_ERROR               29                      /*  VMM Communication Exception */
