...
**--------------文件信息--------------------------------------------------------------------------------
**
** 文   件   名: loongarch_support.h
**
** 创   建   人: Wang.Ziyang (王子阳)
**
** 文件创建日期: 2021 年 10 月 18 日
**
** 描        述: LoongArch 体系架构支持.
*********************************************************************************************************/

#ifndef __ARCH_LOONGARCH_SUPPORT_H
#define __ARCH_LOONGARCH_SUPPORT_H
...
VOID        archCrtCtxEnableFpu(ARCH_REG_CTX  *pregctx);
#define __ARCH_CRT_CTX_ENABLE_FPU   archCrtCtxEnableFpu
#endif                                                                  /*  LW_CFG_CPU_FPU_EN > 0       */
#endif                                                                  /*  LW_CFG_COROUTINE_EN > 0     */

/*********************************************************************************************************
  LoongArch 处理器快速获取线程上下文相关接口
*********************************************************************************************************/

#if LW_CFG_CPU_FAST_TLS > 0
#define __ARCH_FAST_TLS_TID() \
({ \
    REGISTER PLW_CLASS_TCB ptcb asm("$r21"); \
    ptcb->TCB_ulId; \
})
...
/*********************************************************************************************************
  LoongArch 处理器 CACHE 操作
*********************************************************************************************************/

#define LOONGARCH_MACHINE_AUTO         "auto"
#define LOONGARCH_MACHINE_3A5000       "loongson3a5000"
#define LOONGARCH_MACHINE_2K0500       "loongson2k0500"
...
/*********************************************************************************************************
  LoongArch 处理器 MMU 操作 (armMmu*() 可供给 bsp 使用)
*********************************************************************************************************/
...
#define KN_SYNC()               __asm__ __volatile__ ("dbar 0" : : : "memory")
...
#define LOONGARCH_FPU_AUTO     "auto"
#define LOONGARCH_FPU_VFP32    "vfp32"
#define LOONGARCH_FPU_VFP64    "vfp64"
#define LOONGARCH_FPU_NONE     "none"
...
VOID    archFpuCtxInit(PVOID pvFpuCtx, BOOL bEnableException);
...
ULONG   bspCpuLogic2Physical(ULONG  ulCPUId);                           /*  获得物理 CPU ID             */
#endif

#if LW_CFG_CPU_ARCH_HETRC > 0
ULONG   bspCpuLogic2Hetrcc(ULONG  ulCPUId);                             /*  获取算力簇 ID               */
#endif
#endif                                                                  /*  LW_CFG_SMP_EN               */

/*********************************************************************************************************
  LoongArch 处理器 CPU 功耗 (升降主频)
*********************************************************************************************************/
...
#endif                                                                  /*  __ARCH_LOONGARCH_SUPPORT_H  */
/*********************************************************************************************************
  END
*********************************************************************************************************/
