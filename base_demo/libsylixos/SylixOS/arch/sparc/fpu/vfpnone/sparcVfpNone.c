...
/*********************************************************************************************************
** 函数名称: sparcVfpNoneEnableException
** 功能描述: 使能 VFP 上下文异常
** 输　入  : pvFpuCtx  VFP 上下文
** 输　出  : NONE
** 全局变量:
** 调用模块:
*********************************************************************************************************/
static VOID  sparcVfpNoneEnableException (PVOID pvFpuCtx)
{
}
/*********************************************************************************************************
...
PSPARC_FPU_OP  sparcVfpNonePrimaryInit (CPCHAR  pcMachineName, CPCHAR  pcFpuName)
{
    ...
    _G_fpuopVfpNone.SFPU_pfuncEnableException = sparcVfpNoneEnableException;
