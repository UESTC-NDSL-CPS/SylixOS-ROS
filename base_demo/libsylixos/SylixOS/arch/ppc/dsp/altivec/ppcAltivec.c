...
static VOID  ppcAltivecEnableTask (PLW_CLASS_TCB  ptcbCur)
{
    ...
    pregctx->REG_uiMsr |= ARCH_PPC_MSR_VEC;
...
/*********************************************************************************************************
** 函数名称: ppcAltivecEnableException
** 功能描述: 使能 ALTIVEC 上下文异常
** 输　入  : pvDspCtx  ALTIVEC 上下文
** 输　出  : NONE
** 全局变量:
** 调用模块:
*********************************************************************************************************/
static VOID  ppcAltivecEnableException (PVOID  pvDspCtx)
{
}
/*********************************************************************************************************
...
PPPC_DSP_OP  ppcAltivecPrimaryInit (CPCHAR  pcMachineName, CPCHAR  pcDspName)
{
    ...
    _G_dspopAltivec.PDSP_pfuncEnableException = ppcAltivecEnableException;
