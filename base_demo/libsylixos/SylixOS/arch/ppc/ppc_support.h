...
#define __ARCH_CRT_CTX_ENABLE_DSP   archCrtCtxEnableDsp
#endif                                                                  /*  LW_CFG_CPU_DSP_EN > 0       */
#endif                                                                  /*  LW_CFG_COROUTINE_EN > 0     */

/*********************************************************************************************************
  PowerPC 处理器快速获取线程上下文相关接口
*********************************************************************************************************/

#if LW_CFG_CPU_FAST_TLS > 0
#define __ARCH_FAST_TLS_TID() \
({ \
    REGISTER PLW_CLASS_TCB ptcb asm("r18"); \
    ptcb->TCB_ulId; \
})
...
VOID    archDspCtxInit(PVOID pvDspCtx, BOOL bEnableException);
