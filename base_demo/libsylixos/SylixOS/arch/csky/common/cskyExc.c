...
#include "../param/cskyParam.h"
#include "./unaligned/cskyUnaligned.h"
#if LW_CFG_VMM_EN > 0
#include "../mm/mmu/cskyMmu.h"
#endif
#if LW_CFG_CPU_FPU_EN > 0
#include "../fpu/cskyFpu.h"
#include "../fpu/fpu/cskyVfp.h"
#endif
/*********************************************************************************************************
  异常向量表
*********************************************************************************************************/
...
** 调用模块:
*********************************************************************************************************/
VOID  archFloatPointExceptHandle (ULONG  ulVector, ARCH_REG_CTX  *pregctx)
{
    LW_VMM_ABORT    abtInfo;
    PLW_CLASS_TCB   ptcbCur;
#if LW_CFG_CPU_FPU_EN > 0
