...
/*********************************************************************************************************
** 函数名称: mipsHr2VectorEnableException
** 功能描述: 使能 DSP 上下文异常
...
** 调用模块:
*********************************************************************************************************/
static VOID  mipsHr2VectorEnableException (PVOID  pvDspCtx)
{
}
/*********************************************************************************************************
...
PMIPS_DSP_OP  mipsHr2VectorPrimaryInit (CPCHAR  pcMachineName, CPCHAR  pcDspName)
{
    ...
    _G_dspopHr2Vector.MDSP_pfuncEnableException = mipsHr2VectorEnableException;
