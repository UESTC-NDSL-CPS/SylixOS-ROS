...
/*********************************************************************************************************
** 函数名称: mipsVfpNoneEnableException
** 功能描述: 使能 VFP 上下文异常
...
** 调用模块:
*********************************************************************************************************/
static VOID  mipsVfp32EnableException (PVOID  pvFpuCtx)
{
    LW_FPU_CONTEXT  *pfpuCtx    = (LW_FPU_CONTEXT *)pvFpuCtx;
    ARCH_FPU_CTX    *pcpufpuCtx = &pfpuCtx->FPUCTX_fpuctxContext;

    pcpufpuCtx->FPUCTX_uiFcsr |= FPU_CSR_INV_E | FPU_CSR_DIV_E | FPU_CSR_OVF_E | FPU_CSR_UDF_E;
}
/*********************************************************************************************************
...
PMIPS_FPU_OP  mipsVfp32PrimaryInit (CPCHAR  pcMachineName, CPCHAR  pcFpuName)
{
    ...
    _G_fpuopVfp32.MFPU_pfuncEnableException = mipsVfp32EnableException;
