...
/*********************************************************************************************************
** 函数名称: arm64VfpV4El2EnableException
** 功能描述: 使能 VFP 上下文异常
...
** 调用模块:
*********************************************************************************************************/
static VOID  arm64VfpV4El2EnableException (PVOID  pvFpuCtx)
{
    LW_FPU_CONTEXT  *pfpuCtx    = (LW_FPU_CONTEXT *)pvFpuCtx;
    ARCH_FPU_CTX    *pcpufpuCtx = &pfpuCtx->FPUCTX_fpuctxContext;

    pcpufpuCtx->FPUCTX_uiFpcr |= FPCR_IDE | FPCR_UFE | FPCR_OFE | FPCR_DZE | FPCR_IOE;
}
/*********************************************************************************************************
...
PARM64_FPU_OP  arm64VfpV4El2PrimaryInit (CPCHAR  pcMachineName, CPCHAR  pcFpuName)
{
    ...
    _G_fpuopVfpV4El2.AFPU_pfuncEnableException = arm64VfpV4El2EnableException;
