...
/*********************************************************************************************************
** 函数名称: pciStorageAtaCtrlIch8Delay
** 功能描述: ICH8 控制器延时处理（无实际操作）
** 输　入  : hCtrl      控制器句柄
** 输　出  : NONE
** 全局变量:
** 调用模块:
*********************************************************************************************************/
static VOID  pciStorageAtaCtrlIch8Delay (ATA_CTRL_HANDLE  hCtrl)
{
}
/*********************************************************************************************************
                                    ...
                                    ATA_CTRL_CFG_HANDLE  hCtrlCfg)
{
    ...
    case PCI_VENDOR_ID_INTEL:
        ...
        } else if (usDeviceId == PCI_DEVICE_ID_INTEL_ICH8_6) {
            hCtrlCfg->ATACTRLCFG_pfuncDelay = (FUNCPTR)pciStorageAtaCtrlIch8Delay;
        }
        break;
