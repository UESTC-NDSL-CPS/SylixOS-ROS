...
/*********************************************************************************************************
  宏操作
*********************************************************************************************************/
#define BLK_READ(pblk, buf, sec, num, remain)  (pblk)->BLKD_pfuncBlkRd((pblk), (buf), (sec), (num), (remain))
                            ...
                            UINT64                 u64FsKey)
{
    ...
    MONITOR_EVT_LONG4(MONITOR_EVENT_ID_IO, MONITOR_EVENT_DISK_WRITE,
                      ulStartSector, ulSectorCount,
                      ptcbCur->TCB_ulId, ptcbCur->TCB_cThreadName, LW_NULL);
                           ...
                           ULONG                  ulRemainCount)
{
    ...
    MONITOR_EVT_LONG4(MONITOR_EVENT_ID_IO, MONITOR_EVENT_DISK_READ,
                      ulStartSector, ulSectorCount,
                      ptcbCur->TCB_ulId, ptcbCur->TCB_cThreadName, LW_NULL);
