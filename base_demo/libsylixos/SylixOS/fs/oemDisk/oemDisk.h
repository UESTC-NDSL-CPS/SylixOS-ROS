...
LW_API INT               API_OemDiskGetNPart(PLW_OEMDISK_CB  poemd);
LW_API INT               API_OemDiskGetPath(PLW_OEMDISK_CB  poemd, INT  iIndex, 
                                            PCHAR  pcPath, size_t stSize);
LW_API INT               API_OemDiskFsUmount(PLW_OEMDISK_CB  poemd, INT  iIndex);
...
#define oemDiskGetNPart             API_OemDiskGetNPart
#define oemDiskGetPath              API_OemDiskGetPath
#define oemDiskFsUmount             API_OemDiskFsUmount
