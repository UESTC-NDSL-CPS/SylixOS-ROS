...
#define LW_BLKD_DISKCACHE_SET_OPT       LW_OSIOD('b', 151, INT)         /*  设置 CACHE 选项 (已废弃)    */
...
#define LW_DCATTR_BOPT_HIGH_SPEED       0x08                            /*  高速磁盘设备                */
#define LW_DCATTR_BOPT_WRITE_THROUGH    0x10                            /*  写穿透模式                  */
...
typedef struct {
    ...
    size_t          DCATTR_stDirectThreshold;                           /*  高速设备直接读写阀值        */
    ULONG           DCATTR_ulReserved[7];                               /*  保留                        */
} LW_DISKCACHE_ATTR;
