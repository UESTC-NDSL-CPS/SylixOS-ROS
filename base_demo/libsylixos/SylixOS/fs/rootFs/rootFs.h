...
#define LW_ROOTFS_NODE_OPT_ROOTFS_EXTDIR    0x02                        /*  扩展目录, 不能创建 rfs 节点 */

LW_API INT          API_RootFsMakeNode(CPCHAR  pcName, INT  iNodeType, INT  iNodeOpts,
                                       mode_t  iMode, PVOID  pvValue);
