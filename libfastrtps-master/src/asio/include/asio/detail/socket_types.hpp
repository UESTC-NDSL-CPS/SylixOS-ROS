...
# if (defined(__MACH__) && defined(__APPLE__)) \
   ...
   || defined(__OpenBSD__) || defined(__linux__) || defined(SYLIXOS) \
...
# define ASIO_OS_DEF_MSG_PEEK MSG_PEEK
#if defined(SYLIXOS)
# define BOOST_ASIO_OS_DEF_MSG_DONTROUTE 0
# define ASIO_OS_DEF_MSG_DONTROUTE 0
#else
# define ASIO_OS_DEF_MSG_DONTROUTE MSG_DONTROUTE
#endif
...
# endif
/*
 * SylixOS ²»Ö§³Ö AI_ADDRCONFIG
 */
# if defined(AI_ADDRCONFIG) && !defined(__QNXNTO__)  && !defined(SYLIXOS)
#  define ASIO_OS_DEF_AI_ADDRCONFIG AI_ADDRCONFIG
# else
#  define ASIO_OS_DEF_AI_ADDRCONFIG 0
# endif
# if defined(IOV_MAX)  && !defined(SYLIXOS)
