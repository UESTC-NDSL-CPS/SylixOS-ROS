...
# Target
#*********************************************************************************************************
LOCAL_TARGET_NAME := librmw_fastrtps_cpp.so

#*********************************************************************************************************
# Source list
#*********************************************************************************************************
LOCAL_SRCS :=  \
src/rmw_fastrtps_cpp/src/get_client.cpp \
src/rmw_fastrtps_cpp/src/get_participant.cpp \
src/rmw_fastrtps_cpp/src/get_publisher.cpp \
src/rmw_fastrtps_cpp/src/get_service.cpp \
src/rmw_fastrtps_cpp/src/get_subscriber.cpp \
src/rmw_fastrtps_cpp/src/identifier.cpp \
src/rmw_fastrtps_cpp/src/init_rmw_context_impl.cpp \
src/rmw_fastrtps_cpp/src/publisher.cpp \
src/rmw_fastrtps_cpp/src/rmw_client.cpp \
src/rmw_fastrtps_cpp/src/rmw_compare_gids_equal.cpp \
src/rmw_fastrtps_cpp/src/rmw_count.cpp \
src/rmw_fastrtps_cpp/src/rmw_event.cpp \
src/rmw_fastrtps_cpp/src/rmw_features.cpp \
src/rmw_fastrtps_cpp/src/rmw_get_endpoint_network_flow.cpp \
src/rmw_fastrtps_cpp/src/rmw_get_gid_for_publisher.cpp \
src/rmw_fastrtps_cpp/src/rmw_get_implementation_identifier.cpp \
src/rmw_fastrtps_cpp/src/rmw_get_serialization_format.cpp \
src/rmw_fastrtps_cpp/src/rmw_get_topic_endpoint_info.cpp \
src/rmw_fastrtps_cpp/src/rmw_guard_condition.cpp \
src/rmw_fastrtps_cpp/src/rmw_init.cpp \
src/rmw_fastrtps_cpp/src/rmw_logging.cpp \
src/rmw_fastrtps_cpp/src/rmw_node.cpp \
src/rmw_fastrtps_cpp/src/rmw_node_info_and_types.cpp \
src/rmw_fastrtps_cpp/src/rmw_node_names.cpp \
src/rmw_fastrtps_cpp/src/rmw_publish.cpp \
src/rmw_fastrtps_cpp/src/rmw_publisher.cpp \
src/rmw_fastrtps_cpp/src/rmw_qos.cpp \
src/rmw_fastrtps_cpp/src/rmw_request.cpp \
src/rmw_fastrtps_cpp/src/rmw_response.cpp \
src/rmw_fastrtps_cpp/src/rmw_serialize.cpp \
src/rmw_fastrtps_cpp/src/rmw_service.cpp \
src/rmw_fastrtps_cpp/src/rmw_service_names_and_types.cpp \
src/rmw_fastrtps_cpp/src/rmw_service_server_is_available.cpp \
src/rmw_fastrtps_cpp/src/rmw_subscription.cpp \
src/rmw_fastrtps_cpp/src/rmw_take.cpp \
src/rmw_fastrtps_cpp/src/rmw_topic_names_and_types.cpp \
src/rmw_fastrtps_cpp/src/rmw_trigger_guard_condition.cpp \
src/rmw_fastrtps_cpp/src/rmw_wait.cpp \
src/rmw_fastrtps_cpp/src/rmw_wait_set.cpp \
src/rmw_fastrtps_cpp/src/serialization_format.cpp \
src/rmw_fastrtps_cpp/src/subscription.cpp \
src/rmw_fastrtps_cpp/src/type_support_common.cpp

#*********************************************************************************************************
# Header file search path (eg. LOCAL_INC_PATH := -I"Your header files search path")
#*********************************************************************************************************
LOCAL_INC_PATH :=  \
-I"./src/rmw_fastrtps_cpp/include" \
