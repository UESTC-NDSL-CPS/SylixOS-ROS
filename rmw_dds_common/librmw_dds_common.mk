...
# Target
#*********************************************************************************************************
LOCAL_TARGET_NAME := librmw_dds_common.so

#*********************************************************************************************************
# Source list
#*********************************************************************************************************
LOCAL_SRCS :=  \
src/rmw_dds_common_src/rmw_dds_common/src/gid_utils.cpp \
src/rmw_dds_common_src/rmw_dds_common/src/graph_cache.cpp \
src/rmw_dds_common_src/rmw_dds_common/src/qos.cpp \
src/rmw_dds_common_src/rmw_dds_common/src/security.cpp \
src/rmw_dds_common_src/rmw_dds_common/src/time_utils.cpp

#*********************************************************************************************************
# Header file search path (eg. LOCAL_INC_PATH := -I"Your header files search path")
#*********************************************************************************************************
LOCAL_INC_PATH :=  \
-I"./src/rmw_dds_common_src/rmw_dds_common/include" \
