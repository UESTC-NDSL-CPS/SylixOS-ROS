...
#--------------文件信息--------------------------------------------------------------------------------
#
# 文   件   名: librmw_dds_common__rosidl_typesupport_fastrtps_c.mk
#
# 创   建   人: RealEvo-IDE
#
...
# Target
#*********************************************************************************************************
LOCAL_TARGET_NAME := librmw_dds_common__rosidl_typesupport_fastrtps_c.so

#*********************************************************************************************************
# Source list
#*********************************************************************************************************
LOCAL_SRCS :=  \
src/rmw_dds_common/rosidl_typesupport_fastrtps_c/rmw_dds_common/msg/detail/gid__type_support_c.cpp \
src/rmw_dds_common/rosidl_typesupport_fastrtps_c/rmw_dds_common/msg/detail/node_entities_info__type_support_c.cpp \
src/rmw_dds_common/rosidl_typesupport_fastrtps_c/rmw_dds_common/msg/detail/participant_entities_info__type_support_c.cpp

#*********************************************************************************************************
# Header file search path (eg. LOCAL_INC_PATH := -I"Your header files search path")
#*********************************************************************************************************
LOCAL_INC_PATH :=  \
-I"./src/rmw_dds_common/rosidl_typesupport_fastrtps_c" \
...
-I"./src/rmw_dds_common/rosidl_generator_c"
